...
Bot_Name = (Redis:get(SILV.."Mero:Name:Bot") or "فهد")
...
if Redis:sismember(SILV.."medalid",msg.sender_id.user_id) then
local medaa2 = Redis:get(SILV.."medal2"..msg.sender_id.user_id)
if medaa2 == "🥇" then
local medaa = Redis:get(SILV.."medal"..msg.sender_id.user_id)
local medaa2 = Redis:get(SILV.."medal2"..msg.sender_id.user_id)
local medaa3 = Redis:get(SILV.."medal3"..msg.sender_id.user_id)
...
if text == Redis:get(SILV..'klmahzr'..msg.chat_id) and msg.sender_id.user_id == Redis:get(SILV..'playerhzr'..msg.chat_id) then
if not Redis:get(SILV.."playerhzrktm"..msg.chat_id..msg.sender_id.user_id) then
playerhzr = Redis:get(SILV..'playerhzr'..msg.chat_id)
Redis:srem(SILV.."Mero:SilentGroup:Group"..msg.chat_id,playerhzr) 
Redis:del(SILV.."playerhzrktm"..msg.chat_id..playerhzr)
end
end
if text and Redis:get(SILV.."Start_egabahzr"..msg.chat_id) then
playerhzr = Redis:get(SILV..'playerhzr'..msg.chat_id)
klmahzr = Redis:get(SILV..'klmahzr'..msg.chat_id)
...
Redis:del(SILV.."Start_egabahzr"..msg.chat_id)
Redis:del(SILV.."playerhzrktm"..msg.chat_id..msg.sender_id.user_id)
Redis:srem(SILV.."Mero:SilentGroup:Group"..msg.chat_id,msg.sender_id.user_id) 
send(msg.chat_id,msg.id,"「 "..news.." 」\n⇜ كفو عليك حزرت الإجابة ( "..klmahzr.." )\n⇜ تم فك الكتم عنك \n✧ ","md",true)
end
end
end

if not Redis:get(SILV.."lock_getpankiuserall") or not Redis:get(SILV.."lock_getpankiuser"..msg.chat_id) then
if text == 'بنك' or text == 'البنك' then
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
{text = 'المعرض', data = msg.sender_id.user_id..'/almardes'},
},
{
{text = 'المزارع', data = msg.sender_id.user_id..'/almazras'},  {text = 'النوادي', data = msg.sender_id.user_id..'/nawadyss'},
},
{
{text = 'الشركات', data = msg.sender_id.user_id..'/copmaha'},
},
}
}
local TextHelp = [[
...
⌯ حظ ↢ تلعبها بأي مبلغ ياتدبله ياتخسره أنت وحظك

⌯ مضاربه ↢ تضارب بأي مبلغ تبيه والنسبة من ٩٠٪؜ الى -٩٠٪؜ أنت وحظك
...
⌯ توب الفلوس ↢ يطلع توب اكثر ناس معهم فلوس بكل الجروبات
...
cobnum = tonumber(Redis:get(SILV.."bandid"..msg.sender_id.user_id))
if cobnum == msg.sender_id.user_id then
return send(msg.chat_id,msg.id, "⇜ حسابك محظور من لعبة البنك","md",true)
end
if Redis:sismember(SILV.."booob",msg.sender_id.user_id) then
...
Redis:srem(SILV.."booob", msg.sender_id.user_id)
Redis:srem(SILV.."taza", msg.sender_id.user_id)
Redis:del(SILV.."boob"..msg.sender_id.user_id)
Redis:del(SILV.."boobb"..msg.sender_id.user_id)
Redis:del(SILV.."rrfff"..msg.sender_id.user_id)
Redis:srem(SILV.."rrfffid", msg.sender_id.user_id)
Redis:srem(SILV.."roogg1", msg.sender_id.user_id)
Redis:srem(SILV.."roogga1", msg.sender_id.user_id)
Redis:del(SILV.."roog1"..msg.sender_id.user_id)
Redis:del(SILV.."rooga1"..msg.sender_id.user_id)
Redis:del(SILV.."rahr1"..msg.sender_id.user_id)
Redis:del(SILV.."rahrr1"..msg.sender_id.user_id)
Redis:del(SILV.."tabbroat"..msg.sender_id.user_id)
Redis:del(SILV.."shkse"..msg.sender_id.user_id)
Redis:del(SILV.."doltebank"..msg.sender_id.user_id)
Redis:del(SILV.."ratbinc"..msg.sender_id.user_id)
Redis:del(SILV.."ratbtrans"..msg.sender_id.user_id)
Redis:del(SILV.."mgrmasname"..msg.sender_id.user_id)
Redis:del(SILV.."mgrmasnum"..msg.sender_id.user_id)
Redis:del(SILV.."mgrkldname"..msg.sender_id.user_id)
Redis:del(SILV.."mgrkldnum"..msg.sender_id.user_id)
Redis:del(SILV.."mgrswrname"..msg.sender_id.user_id)
Redis:del(SILV.."mgrswrnum"..msg.sender_id.user_id)
Redis:del(SILV.."mgrktmname"..msg.sender_id.user_id)
Redis:del(SILV.."mgrktmnum"..msg.sender_id.user_id)
Redis:del(SILV.."akrksrname"..msg.sender_id.user_id)
Redis:del(SILV.."akrksrnum"..msg.sender_id.user_id)
Redis:del(SILV.."akrfelname"..msg.sender_id.user_id)
Redis:del(SILV.."akrfelnum"..msg.sender_id.user_id)
Redis:del(SILV.."akrmnzname"..msg.sender_id.user_id)
Redis:del(SILV.."akrmnznum"..msg.sender_id.user_id)
Redis:del(SILV.."airshbhname"..msg.sender_id.user_id)
Redis:del(SILV.."airshbhnum"..msg.sender_id.user_id)
Redis:del(SILV.."airsfarname"..msg.sender_id.user_id)
Redis:del(SILV.."airsfarnum"..msg.sender_id.user_id)
Redis:del(SILV.."airkhasname"..msg.sender_id.user_id)
Redis:del(SILV.."airkhasnum"..msg.sender_id.user_id)
Redis:del(SILV.."carrangname"..msg.sender_id.user_id)
Redis:del(SILV.."carrangnum"..msg.sender_id.user_id)
Redis:del(SILV.."caraccename"..msg.sender_id.user_id)
Redis:del(SILV.."caraccenum"..msg.sender_id.user_id)
Redis:del(SILV.."carcamrname"..msg.sender_id.user_id)
Redis:del(SILV.."carcamrnum"..msg.sender_id.user_id)
Redis:del(SILV.."caralntrname"..msg.sender_id.user_id)
Redis:del(SILV.."caralntrnum"..msg.sender_id.user_id)
Redis:del(SILV.."carhilxname"..msg.sender_id.user_id)
Redis:del(SILV.."carhilxnum"..msg.sender_id.user_id)
Redis:del(SILV.."carsonaname"..msg.sender_id.user_id)
Redis:del(SILV.."carsonanum"..msg.sender_id.user_id)
Redis:del(SILV.."carcoroname"..msg.sender_id.user_id)
Redis:del(SILV.."carcoronum"..msg.sender_id.user_id)
namfra = Redis:get(SILV.."namefram"..msg.sender_id.user_id)
Redis:del(SILV.."toplvfarm"..msg.sender_id.user_id)
Redis:del(SILV.."btatatime"..msg.sender_id.user_id)
Redis:del(SILV.."btatanum"..msg.sender_id.user_id)
Redis:del(SILV.."btataname"..msg.sender_id.user_id)
Redis:del(SILV.."lemontime"..msg.sender_id.user_id)
Redis:del(SILV.."lemonnum"..msg.sender_id.user_id)
Redis:del(SILV.."lemonname"..msg.sender_id.user_id)
Redis:del(SILV.."khesstime"..msg.sender_id.user_id)
Redis:del(SILV.."khessnum"..msg.sender_id.user_id)
Redis:del(SILV.."khessname"..msg.sender_id.user_id)
Redis:del(SILV.."kheartime"..msg.sender_id.user_id)
Redis:del(SILV.."khearnum"..msg.sender_id.user_id)
Redis:del(SILV.."khearname"..msg.sender_id.user_id)
Redis:del(SILV.."jzartime"..msg.sender_id.user_id)
Redis:del(SILV.."jzarnum"..msg.sender_id.user_id)
Redis:del(SILV.."jzarname"..msg.sender_id.user_id)
Redis:del(SILV.."fleflatime"..msg.sender_id.user_id)
Redis:del(SILV.."fleflanum"..msg.sender_id.user_id)
Redis:del(SILV.."fleflaname"..msg.sender_id.user_id)
Redis:del(SILV.."freaztime"..msg.sender_id.user_id)
Redis:del(SILV.."freaznum"..msg.sender_id.user_id)
Redis:del(SILV.."freazname"..msg.sender_id.user_id)
Redis:del(SILV.."doratime"..msg.sender_id.user_id)
Redis:del(SILV.."doranum"..msg.sender_id.user_id)
Redis:del(SILV.."doraname"..msg.sender_id.user_id)
Redis:del(SILV.."tomtime"..msg.sender_id.user_id)
Redis:del(SILV.."tomnum"..msg.sender_id.user_id)
Redis:del(SILV.."tomname"..msg.sender_id.user_id)
Redis:del(SILV.."ftrtime"..msg.sender_id.user_id)
Redis:del(SILV.."ftrnum"..msg.sender_id.user_id)
Redis:del(SILV.."ftrname"..msg.sender_id.user_id)
Redis:del(SILV.."tfahtime"..msg.sender_id.user_id)
Redis:del(SILV.."tfahnum"..msg.sender_id.user_id)
Redis:del(SILV.."tfahname"..msg.sender_id.user_id)
Redis:del(SILV.."enabtime"..msg.sender_id.user_id)
Redis:del(SILV.."enabnum"..msg.sender_id.user_id)
Redis:del(SILV.."enabname"..msg.sender_id.user_id)
Redis:del(SILV.."zetontime"..msg.sender_id.user_id)
Redis:del(SILV.."zetonnum"..msg.sender_id.user_id)
Redis:del(SILV.."zetonname"..msg.sender_id.user_id)
Redis:del(SILV.."mozztime"..msg.sender_id.user_id)
Redis:del(SILV.."mozznum"..msg.sender_id.user_id)
Redis:del(SILV.."mozzname"..msg.sender_id.user_id)
Redis:del(SILV.."mangatime"..msg.sender_id.user_id)
Redis:del(SILV.."manganum"..msg.sender_id.user_id)
Redis:del(SILV.."manganame"..msg.sender_id.user_id)
Redis:del(SILV.."sizefram"..msg.sender_id.user_id)
Redis:del(SILV.."namefram"..msg.sender_id.user_id)
Redis:del(SILV.."mzroatsize"..msg.sender_id.user_id)
Redis:srem(SILV.."farmarname", namfra)
Redis:srem(SILV.."ownerfram",msg.sender_id.user_id)
namenad = Redis:get(SILV.."lkbnade"..msg.sender_id.user_id)
Redis:del(SILV.."namenade"..msg.sender_id.user_id)
Redis:del(SILV.."nokatnade"..msg.sender_id.user_id)
Redis:del(SILV.."energynade"..msg.sender_id.user_id)
Redis:del(SILV.."traningnade"..msg.sender_id.user_id)
Redis:del(SILV.."nameplayer".."1"..msg.sender_id.user_id)
Redis:del(SILV.."nameplayer".."2"..msg.sender_id.user_id)
Redis:del(SILV.."nameplayer".."3"..msg.sender_id.user_id)
Redis:del(SILV.."nameplayer".."4"..msg.sender_id.user_id)
Redis:del(SILV.."nameplayer".."5"..msg.sender_id.user_id)
Redis:del(SILV.."energyplayer".."1"..msg.sender_id.user_id)
Redis:del(SILV.."energyplayer".."2"..msg.sender_id.user_id)
Redis:del(SILV.."energyplayer".."3"..msg.sender_id.user_id)
Redis:del(SILV.."energyplayer".."4"..msg.sender_id.user_id)
Redis:del(SILV.."energyplayer".."5"..msg.sender_id.user_id)
Redis:del(SILV.."mrkzplayer".."1"..msg.sender_id.user_id)
Redis:del(SILV.."mrkzplayer".."2"..msg.sender_id.user_id)
Redis:del(SILV.."mrkzplayer".."3"..msg.sender_id.user_id)
Redis:del(SILV.."mrkzplayer".."4"..msg.sender_id.user_id)
Redis:del(SILV.."mrkzplayer".."5"..msg.sender_id.user_id)
Redis:del(SILV.."cityplayer".."1"..msg.sender_id.user_id)
Redis:del(SILV.."cityplayer".."2"..msg.sender_id.user_id)
Redis:del(SILV.."cityplayer".."3"..msg.sender_id.user_id)
Redis:del(SILV.."cityplayer".."4"..msg.sender_id.user_id)
Redis:del(SILV.."cityplayer".."5"..msg.sender_id.user_id)
Redis:del(SILV.."priceplayer".."1"..msg.sender_id.user_id)
Redis:del(SILV.."priceplayer".."2"..msg.sender_id.user_id)
Redis:del(SILV.."priceplayer".."3"..msg.sender_id.user_id)
Redis:del(SILV.."priceplayer".."4"..msg.sender_id.user_id)
Redis:del(SILV.."priceplayer".."5"..msg.sender_id.user_id)
Redis:srem(SILV.."lkbnadesadd", namenad)
Redis:srem(SILV.."ownernade",msg.sender_id.user_id)
Redis:del(SILV.."lkbnade"..msg.sender_id.user_id)
else
...
if Redis:sismember(SILV.."booob",UserId_Info.id) then
ballanceed = Redis:get(SILV.."boob"..UserId_Info.id) or 0
...
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n⇜ ماعندها حساب بالبنك ","md",true)  
return false
end
if Redis:sismember(SILV.."booob",Remsg.sender_id.user_id) then
ballanceed = Redis:get(SILV.."boob"..Remsg.sender_id.user_id) or 0
local convert_mony = string.format("%.0f",ballanceed)
send(msg.chat_id,msg.id, "⇜ فلوسه `"..convert_mony.."` ريال 💵","md",true)
else
send(msg.chat_id,msg.id, "⇜ ماعنده حساب بنكي ","md",true)
...
if Redis:sismember(SILV.."booob",msg.sender_id.user_id) then
cccc = Redis:get(SILV.."boobb"..msg.sender_id.user_id)
uuuu = Redis:get(SILV.."bbobb"..msg.sender_id.user_id)
pppp = Redis:get(SILV.."rrfff"..msg.sender_id.user_id) or 0
ballancee = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
shkse = Redis:get(SILV.."shkse"..msg.sender_id.user_id)
doltebank = Redis:get(SILV.."doltebank"..msg.sender_id.user_id)
local convert_mony = string.format("%.0f",ballancee)
if shkse == "طيبة" then
shkseemg = "طيبة 😇"
else
...
local UserInfo = bot.getUser(Remsg.sender_id.user_id)
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n⇜بوت ماعندها حساب بالبنك ","md",true)  
return false
end
...
if Redis:sismember(SILV.."booob",Remsg.sender_id.user_id) then
local Cname = Redis:get(SILV.."in_company:name:"..msg.sender_id.user_id) or 0
Redis:srem(SILV.."company:mem:"..Cname, msg.sender_id.user_id)
Redis:srem(SILV.."in_company:", msg.sender_id.user_id)
Redis:del(SILV.."in_company:name:"..msg.sender_id.user_id, Cname)
ccccc = Redis:get(SILV.."boobb"..Remsg.sender_id.user_id)
uuuuu = Redis:get(SILV.."bbobb"..Remsg.sender_id.user_id)
ppppp = Redis:get(SILV.."rrfff"..Remsg.sender_id.user_id) or 0
ballanceed = Redis:get(SILV.."boob"..Remsg.sender_id.user_id) or 0
local convert_mony = string.format("%.0f",ballanceed)
Redis:srem(SILV.."booob", Remsg.sender_id.user_id)
Redis:srem(SILV.."taza", Remsg.sender_id.user_id)
namfra = Redis:get(SILV.."namefram"..Remsg.sender_id.user_id)
Redis:del(SILV.."boob"..Remsg.sender_id.user_id)
Redis:del(SILV.."boobb"..Remsg.sender_id.user_id)
Redis:del(SILV.."rrfff"..Remsg.sender_id.user_id)
Redis:del(SILV.."numattack"..Remsg.sender_id.user_id)
Redis:srem(SILV.."rrfffid", Remsg.sender_id.user_id)
Redis:srem(SILV.."roogg1", Remsg.sender_id.user_id)
Redis:srem(SILV.."roogga1", Remsg.sender_id.user_id)
Redis:del(SILV.."roog1"..Remsg.sender_id.user_id)
Redis:del(SILV.."rooga1"..Remsg.sender_id.user_id)
Redis:del(SILV.."rahr1"..Remsg.sender_id.user_id)
Redis:del(SILV.."rahrr1"..Remsg.sender_id.user_id)
Redis:del(SILV.."tabbroat"..Remsg.sender_id.user_id)
Redis:del(SILV.."shkse"..Remsg.sender_id.user_id)
Redis:del(SILV.."doltebank"..Remsg.sender_id.user_id)
Redis:del(SILV.."ratbinc"..Remsg.sender_id.user_id)
Redis:del(SILV.."ratbtrans"..Remsg.sender_id.user_id)
Redis:del(SILV.."mgrmasname"..Remsg.sender_id.user_id)
Redis:del(SILV.."mgrmasnum"..Remsg.sender_id.user_id)
Redis:del(SILV.."mgrkldname"..Remsg.sender_id.user_id)
Redis:del(SILV.."mgrkldnum"..Remsg.sender_id.user_id)
Redis:del(SILV.."mgrswrname"..Remsg.sender_id.user_id)
Redis:del(SILV.."mgrswrnum"..Remsg.sender_id.user_id)
Redis:del(SILV.."mgrktmname"..Remsg.sender_id.user_id)
Redis:del(SILV.."mgrktmnum"..Remsg.sender_id.user_id)
Redis:del(SILV.."akrksrname"..Remsg.sender_id.user_id)
Redis:del(SILV.."akrksrnum"..Remsg.sender_id.user_id)
Redis:del(SILV.."akrfelname"..Remsg.sender_id.user_id)
Redis:del(SILV.."akrfelnum"..Remsg.sender_id.user_id)
Redis:del(SILV.."akrmnzname"..Remsg.sender_id.user_id)
Redis:del(SILV.."akrmnznum"..Remsg.sender_id.user_id)
Redis:del(SILV.."airshbhname"..Remsg.sender_id.user_id)
Redis:del(SILV.."airshbhnum"..Remsg.sender_id.user_id)
Redis:del(SILV.."airsfarname"..Remsg.sender_id.user_id)
Redis:del(SILV.."airsfarnum"..Remsg.sender_id.user_id)
Redis:del(SILV.."airkhasname"..Remsg.sender_id.user_id)
Redis:del(SILV.."airkhasnum"..Remsg.sender_id.user_id)
Redis:del(SILV.."carrangname"..Remsg.sender_id.user_id)
Redis:del(SILV.."carrangnum"..Remsg.sender_id.user_id)
Redis:del(SILV.."caraccename"..Remsg.sender_id.user_id)
Redis:del(SILV.."caraccenum"..Remsg.sender_id.user_id)
Redis:del(SILV.."carcamrname"..Remsg.sender_id.user_id)
Redis:del(SILV.."carcamrnum"..Remsg.sender_id.user_id)
Redis:del(SILV.."caralntrname"..Remsg.sender_id.user_id)
Redis:del(SILV.."caralntrnum"..Remsg.sender_id.user_id)
Redis:del(SILV.."carhilxname"..Remsg.sender_id.user_id)
Redis:del(SILV.."carhilxnum"..Remsg.sender_id.user_id)
Redis:del(SILV.."carsonaname"..Remsg.sender_id.user_id)
Redis:del(SILV.."carsonanum"..Remsg.sender_id.user_id)
Redis:del(SILV.."carcoroname"..Remsg.sender_id.user_id)
Redis:del(SILV.."carcoronum"..Remsg.sender_id.user_id)
Redis:del(SILV.."rotpa"..Remsg.sender_id.user_id)
Redis:del(SILV.."rddd"..Remsg.sender_id.user_id)
Redis:del(SILV.."rotpagrid"..Remsg.sender_id.user_id)
Redis:del(SILV.."rotpaid"..Remsg.sender_id.user_id)
Redis:del(SILV.."rdddgr"..Remsg.sender_id.user_id)
Redis:del(SILV.."rdddid"..Remsg.sender_id.user_id)
Redis:del(SILV.."rdddtex"..Remsg.sender_id.user_id)
Redis:del(SILV.."toplvfarm"..Remsg.sender_id.user_id)
Redis:del(SILV.."btatatime"..Remsg.sender_id.user_id)
Redis:del(SILV.."btatanum"..Remsg.sender_id.user_id)
Redis:del(SILV.."btataname"..Remsg.sender_id.user_id)
Redis:del(SILV.."lemontime"..Remsg.sender_id.user_id)
Redis:del(SILV.."lemonnum"..Remsg.sender_id.user_id)
Redis:del(SILV.."lemonname"..Remsg.sender_id.user_id)
Redis:del(SILV.."khesstime"..Remsg.sender_id.user_id)
Redis:del(SILV.."khessnum"..Remsg.sender_id.user_id)
Redis:del(SILV.."khessname"..Remsg.sender_id.user_id)
Redis:del(SILV.."kheartime"..Remsg.sender_id.user_id)
Redis:del(SILV.."khearnum"..Remsg.sender_id.user_id)
Redis:del(SILV.."khearname"..Remsg.sender_id.user_id)
Redis:del(SILV.."jzartime"..Remsg.sender_id.user_id)
Redis:del(SILV.."jzarnum"..Remsg.sender_id.user_id)
Redis:del(SILV.."jzarname"..Remsg.sender_id.user_id)
Redis:del(SILV.."fleflatime"..Remsg.sender_id.user_id)
Redis:del(SILV.."fleflanum"..Remsg.sender_id.user_id)
Redis:del(SILV.."fleflaname"..Remsg.sender_id.user_id)
Redis:del(SILV.."freaztime"..Remsg.sender_id.user_id)
Redis:del(SILV.."freaznum"..Remsg.sender_id.user_id)
Redis:del(SILV.."freazname"..Remsg.sender_id.user_id)
Redis:del(SILV.."doratime"..Remsg.sender_id.user_id)
Redis:del(SILV.."doranum"..Remsg.sender_id.user_id)
Redis:del(SILV.."doraname"..Remsg.sender_id.user_id)
Redis:del(SILV.."tomtime"..Remsg.sender_id.user_id)
Redis:del(SILV.."tomnum"..Remsg.sender_id.user_id)
Redis:del(SILV.."tomname"..Remsg.sender_id.user_id)
Redis:del(SILV.."ftrtime"..Remsg.sender_id.user_id)
Redis:del(SILV.."ftrnum"..Remsg.sender_id.user_id)
Redis:del(SILV.."ftrname"..Remsg.sender_id.user_id)
Redis:del(SILV.."tfahtime"..Remsg.sender_id.user_id)
Redis:del(SILV.."tfahnum"..Remsg.sender_id.user_id)
Redis:del(SILV.."tfahname"..Remsg.sender_id.user_id)
Redis:del(SILV.."enabtime"..Remsg.sender_id.user_id)
Redis:del(SILV.."enabnum"..Remsg.sender_id.user_id)
Redis:del(SILV.."enabname"..Remsg.sender_id.user_id)
Redis:del(SILV.."zetontime"..Remsg.sender_id.user_id)
Redis:del(SILV.."zetonnum"..Remsg.sender_id.user_id)
Redis:del(SILV.."zetonname"..Remsg.sender_id.user_id)
Redis:del(SILV.."mozztime"..Remsg.sender_id.user_id)
Redis:del(SILV.."mozznum"..Remsg.sender_id.user_id)
Redis:del(SILV.."mozzname"..Remsg.sender_id.user_id)
Redis:del(SILV.."mangatime"..Remsg.sender_id.user_id)
Redis:del(SILV.."manganum"..Remsg.sender_id.user_id)
Redis:del(SILV.."manganame"..Remsg.sender_id.user_id)
Redis:del(SILV.."sizefram"..Remsg.sender_id.user_id)
Redis:del(SILV.."namefram"..Remsg.sender_id.user_id)
Redis:del(SILV.."mzroatsize"..Remsg.sender_id.user_id)
Redis:srem(SILV.."farmarname", namfra)
Redis:srem(SILV.."ownerfram",Remsg.sender_id.user_id)
namenad = Redis:get(SILV.."lkbnade"..Remsg.sender_id.user_id)
Redis:del(SILV.."namenade"..Remsg.sender_id.user_id)
Redis:del(SILV.."nokatnade"..Remsg.sender_id.user_id)
Redis:del(SILV.."energynade"..Remsg.sender_id.user_id)
Redis:del(SILV.."traningnade"..Remsg.sender_id.user_id)
Redis:del(SILV.."nameplayer".."1"..Remsg.sender_id.user_id)
Redis:del(SILV.."nameplayer".."2"..Remsg.sender_id.user_id)
Redis:del(SILV.."nameplayer".."3"..Remsg.sender_id.user_id)
Redis:del(SILV.."nameplayer".."4"..Remsg.sender_id.user_id)
Redis:del(SILV.."nameplayer".."5"..Remsg.sender_id.user_id)
Redis:del(SILV.."energyplayer".."1"..Remsg.sender_id.user_id)
Redis:del(SILV.."energyplayer".."2"..Remsg.sender_id.user_id)
Redis:del(SILV.."energyplayer".."3"..Remsg.sender_id.user_id)
Redis:del(SILV.."energyplayer".."4"..Remsg.sender_id.user_id)
Redis:del(SILV.."energyplayer".."5"..Remsg.sender_id.user_id)
Redis:del(SILV.."mrkzplayer".."1"..Remsg.sender_id.user_id)
Redis:del(SILV.."mrkzplayer".."2"..Remsg.sender_id.user_id)
Redis:del(SILV.."mrkzplayer".."3"..Remsg.sender_id.user_id)
Redis:del(SILV.."mrkzplayer".."4"..Remsg.sender_id.user_id)
Redis:del(SILV.."mrkzplayer".."5"..Remsg.sender_id.user_id)
Redis:del(SILV.."cityplayer".."1"..Remsg.sender_id.user_id)
Redis:del(SILV.."cityplayer".."2"..Remsg.sender_id.user_id)
Redis:del(SILV.."cityplayer".."3"..Remsg.sender_id.user_id)
Redis:del(SILV.."cityplayer".."4"..Remsg.sender_id.user_id)
Redis:del(SILV.."cityplayer".."5"..Remsg.sender_id.user_id)
Redis:del(SILV.."priceplayer".."1"..Remsg.sender_id.user_id)
Redis:del(SILV.."priceplayer".."2"..Remsg.sender_id.user_id)
Redis:del(SILV.."priceplayer".."3"..Remsg.sender_id.user_id)
Redis:del(SILV.."priceplayer".."4"..Remsg.sender_id.user_id)
Redis:del(SILV.."priceplayer".."5"..Remsg.sender_id.user_id)
Redis:srem(SILV.."lkbnadesadd", namenad)
Redis:srem(SILV.."ownernade",Remsg.sender_id.user_id)
Redis:del(SILV.."lkbnade"..Remsg.sender_id.user_id)
...
ppppp = Redis:get(SILV.."rrfff"..Remsg.sender_id.user_id) or 0
ballanceed = Redis:get(SILV.."boob"..Remsg.sender_id.user_id) or 0
shkse = Redis:get(SILV.."shkse"..Remsg.sender_id.user_id)
doltebank = Redis:get(SILV.."doltebank"..Remsg.sender_id.user_id)
local convert_mony = string.format("%.0f",ballanceed)
if shkse == "طيبة" then
shkseemg = "طيبة 😇"
else
...
if Redis:sismember(SILV.."booob",coniss) then
local Cname = Redis:get(SILV.."in_company:name:"..coniss) or 0
Redis:srem(SILV.."company:mem:"..Cname, coniss)
Redis:srem(SILV.."in_company:", coniss)
Redis:del(SILV.."in_company:name:"..coniss, Cname)
ccccc = Redis:get(SILV.."boobb"..coniss)
uuuuu = Redis:get(SILV.."bbobb"..coniss)
ppppp = Redis:get(SILV.."rrfff"..coniss) or 0
ballanceed = Redis:get(SILV.."boob"..coniss) or 0
local convert_mony = string.format("%.0f",ballanceed)
namfra = Redis:get(SILV.."namefram"..coniss)
Redis:srem(SILV.."booob", coniss)
Redis:srem(SILV.."taza", coniss)
Redis:del(SILV.."boob"..coniss)
Redis:del(SILV.."boobb"..coniss)
Redis:del(SILV.."rrfff"..coniss)
Redis:srem(SILV.."roogg1", coniss)
Redis:srem(SILV.."roogga1", coniss)
Redis:del(SILV.."roog1"..coniss)
Redis:del(SILV.."rooga1"..coniss)
Redis:del(SILV.."rahr1"..coniss)
Redis:del(SILV.."rahrr1"..coniss)
Redis:del(SILV.."tabbroat"..coniss)
Redis:del(SILV.."shkse"..coniss)
Redis:del(SILV.."doltebank"..coniss)
Redis:del(SILV.."ratbinc"..coniss)
Redis:del(SILV.."ratbtrans"..coniss)
Redis:del(SILV.."numattack"..coniss)
Redis:del(SILV.."mgrmasname"..coniss)
Redis:del(SILV.."mgrmasnum"..coniss)
Redis:del(SILV.."mgrkldname"..coniss)
Redis:del(SILV.."mgrkldnum"..coniss)
Redis:del(SILV.."mgrswrname"..coniss)
Redis:del(SILV.."mgrswrnum"..coniss)
Redis:del(SILV.."mgrktmname"..coniss)
Redis:del(SILV.."mgrktmnum"..coniss)
Redis:del(SILV.."akrksrname"..coniss)
Redis:del(SILV.."akrksrnum"..coniss)
Redis:del(SILV.."akrfelname"..coniss)
Redis:del(SILV.."akrfelnum"..coniss)
Redis:del(SILV.."akrmnzname"..coniss)
Redis:del(SILV.."akrmnznum"..coniss)
Redis:del(SILV.."airshbhname"..coniss)
Redis:del(SILV.."airshbhnum"..coniss)
Redis:del(SILV.."airsfarname"..coniss)
Redis:del(SILV.."airsfarnum"..coniss)
Redis:del(SILV.."airkhasname"..coniss)
Redis:del(SILV.."airkhasnum"..coniss)
Redis:del(SILV.."carrangname"..coniss)
Redis:del(SILV.."carrangnum"..coniss)
Redis:del(SILV.."caraccename"..coniss)
Redis:del(SILV.."caraccenum"..coniss)
Redis:del(SILV.."carcamrname"..coniss)
Redis:del(SILV.."carcamrnum"..coniss)
Redis:del(SILV.."caralntrname"..coniss)
Redis:del(SILV.."caralntrnum"..coniss)
Redis:del(SILV.."carhilxname"..coniss)
Redis:del(SILV.."carhilxnum"..coniss)
Redis:del(SILV.."carsonaname"..coniss)
Redis:del(SILV.."carsonanum"..coniss)
Redis:del(SILV.."carcoroname"..coniss)
Redis:del(SILV.."carcoronum"..coniss)
Redis:srem(SILV.."rrfffid", coniss)
Redis:del(SILV.."rotpa"..coniss)
Redis:del(SILV.."rddd"..coniss)
Redis:del(SILV.."rotpagrid"..coniss)
Redis:del(SILV.."rotpaid"..coniss)
Redis:del(SILV.."rdddgr"..coniss)
Redis:del(SILV.."rdddid"..coniss)
Redis:del(SILV.."rdddtex"..coniss)
Redis:del(SILV.."toplvfarm"..coniss)
Redis:del(SILV.."btatatime"..coniss)
Redis:del(SILV.."btatanum"..coniss)
Redis:del(SILV.."btataname"..coniss)
Redis:del(SILV.."lemontime"..coniss)
Redis:del(SILV.."lemonnum"..coniss)
Redis:del(SILV.."lemonname"..coniss)
Redis:del(SILV.."khesstime"..coniss)
Redis:del(SILV.."khessnum"..coniss)
Redis:del(SILV.."khessname"..coniss)
Redis:del(SILV.."kheartime"..coniss)
Redis:del(SILV.."khearnum"..coniss)
Redis:del(SILV.."khearname"..coniss)
Redis:del(SILV.."jzartime"..coniss)
Redis:del(SILV.."jzarnum"..coniss)
Redis:del(SILV.."jzarname"..coniss)
Redis:del(SILV.."fleflatime"..coniss)
Redis:del(SILV.."fleflanum"..coniss)
Redis:del(SILV.."fleflaname"..coniss)
Redis:del(SILV.."freaztime"..coniss)
Redis:del(SILV.."freaznum"..coniss)
Redis:del(SILV.."freazname"..coniss)
Redis:del(SILV.."doratime"..coniss)
Redis:del(SILV.."doranum"..coniss)
Redis:del(SILV.."doraname"..coniss)
Redis:del(SILV.."tomtime"..coniss)
Redis:del(SILV.."tomnum"..coniss)
Redis:del(SILV.."tomname"..coniss)
Redis:del(SILV.."ftrtime"..coniss)
Redis:del(SILV.."ftrnum"..coniss)
Redis:del(SILV.."ftrname"..coniss)
Redis:del(SILV.."tfahtime"..coniss)
Redis:del(SILV.."tfahnum"..coniss)
Redis:del(SILV.."tfahname"..coniss)
Redis:del(SILV.."enabtime"..coniss)
Redis:del(SILV.."enabnum"..coniss)
Redis:del(SILV.."enabname"..coniss)
Redis:del(SILV.."zetontime"..coniss)
Redis:del(SILV.."zetonnum"..coniss)
Redis:del(SILV.."zetonname"..coniss)
Redis:del(SILV.."mozztime"..coniss)
Redis:del(SILV.."mozznum"..coniss)
Redis:del(SILV.."mozzname"..coniss)
Redis:del(SILV.."mangatime"..coniss)
Redis:del(SILV.."manganum"..coniss)
Redis:del(SILV.."manganame"..coniss)
Redis:del(SILV.."sizefram"..coniss)
Redis:del(SILV.."namefram"..coniss)
Redis:del(SILV.."mzroatsize"..coniss)
Redis:srem(SILV.."farmarname", namfra)
Redis:srem(SILV.."ownerfram",coniss)
namenad = Redis:get(SILV.."lkbnade"..coniss)
Redis:del(SILV.."namenade"..coniss)
Redis:del(SILV.."nokatnade"..coniss)
Redis:del(SILV.."energynade"..coniss)
Redis:del(SILV.."traningnade"..coniss)
Redis:del(SILV.."nameplayer".."1"..coniss)
Redis:del(SILV.."nameplayer".."2"..coniss)
Redis:del(SILV.."nameplayer".."3"..coniss)
Redis:del(SILV.."nameplayer".."4"..coniss)
Redis:del(SILV.."nameplayer".."5"..coniss)
Redis:del(SILV.."energyplayer".."1"..coniss)
Redis:del(SILV.."energyplayer".."2"..coniss)
Redis:del(SILV.."energyplayer".."3"..coniss)
Redis:del(SILV.."energyplayer".."4"..coniss)
Redis:del(SILV.."energyplayer".."5"..coniss)
Redis:del(SILV.."mrkzplayer".."1"..coniss)
Redis:del(SILV.."mrkzplayer".."2"..coniss)
Redis:del(SILV.."mrkzplayer".."3"..coniss)
Redis:del(SILV.."mrkzplayer".."4"..coniss)
Redis:del(SILV.."mrkzplayer".."5"..coniss)
Redis:del(SILV.."cityplayer".."1"..coniss)
Redis:del(SILV.."cityplayer".."2"..coniss)
Redis:del(SILV.."cityplayer".."3"..coniss)
Redis:del(SILV.."cityplayer".."4"..coniss)
Redis:del(SILV.."cityplayer".."5"..coniss)
Redis:del(SILV.."priceplayer".."1"..coniss)
Redis:del(SILV.."priceplayer".."2"..coniss)
Redis:del(SILV.."priceplayer".."3"..coniss)
Redis:del(SILV.."priceplayer".."4"..coniss)
Redis:del(SILV.."priceplayer".."5"..coniss)
Redis:srem(SILV.."lkbnadesadd", namenad)
Redis:srem(SILV.."ownernade",coniss)
Redis:del(SILV.."lkbnade"..coniss)
send(msg.chat_id,msg.id, "⇜ الاسم ↤ "..news.."\n⇜ الحساب ↤ `"..ccccc.."`\n⇜ بنك ↤ ❲بوت ❳\n⇜ نوع ↤ ❲ "..uuuuu.." ❳\n⇜ الرصيد ↤ ❲ "..convert_mony.." ❳ ريال 💵 )\n⇜ الزرف ↤ ❲ "..math.floor(ppppp).." ريال 💵 ❳\n⇜ مسكين مسحت حسابه","md",true)
else
send(msg.chat_id,msg.id, "⇜ ماعنده حساب بنكي اصلاً ","md",true)
end
...
local coniss = coin(UserName)
if Redis:get(SILV.."boballcc"..coniss) then
local yty = Redis:get(SILV.."boballname"..coniss)
local bobpkh = Redis:get(SILV.."boballid"..coniss)
ballancee = Redis:get(SILV.."boob"..bobpkh) or 0
local convert_mony = string.format("%.0f",ballancee)
local dfhb = Redis:get(SILV.."boballbalc"..coniss)
local fsvhh = Redis:get(SILV.."boballban"..coniss)
shkse = Redis:get(SILV.."shkse"..coniss)
doltebank = Redis:get(SILV.."doltebank"..coniss)
if shkse == "طيبة" then
shkseemg = "طيبة 😇"
else
shkseemg = "شريرة 😈"
end
send(msg.chat_id,msg.id, "⇜ الاسم ↤ "..yty.."\n⇜ الحساب ↤ `"..coniss.."`\n⇜ بنك ↤ ❲بوت ❳\n⇜ نوع ↤ ❲ "..fsvhh.." ❳\n⇜ الرصيد ↤ ❲ "..convert_mony.." ريال 💵 ❳\n⇜ شخصيتك ↤ ❲ "..shkseemg.." ❳","md",true)
else
...
if Redis:sismember(SILV.."booob",msg.sender_id.user_id) then
morakba = tonumber(Redis:get(SILV.."morakba"..msg.sender_id.user_id))
if morakba == msg.sender_id.user_id then
send("-1001966858272",0,"⇜ الايدي ↤ "..msg.sender_id.user_id.."\n⇜ القروب ↤ "..msg.chat_id.."\n⇜ الرسالة ↤ "..text.."\n✧","md",true)
end
if not Redis:sismember(SILV.."Akshtd:Games:",TextAksht) then
...
Redis:srem(SILV.."Akshtd:Games:",TextAksht)
ballancee = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
cobonplus = tonumber(ballancee) + Number
Redis:set(SILV.."boob"..msg.sender_id.user_id , cobonplus)
...
if text == "قائمه اكشطها" or text == "قائمه اكشط" then
if not msg.ControllerBot then
return send(msg.chat_id,msg.id,'\n⇜ هذا الامر يخص المطور الاساسي ',"md",true)  
end
local Text = Redis:smembers(SILV.."Akshtd:Games:") 
if #Text == 0 then
...
Redis:sadd(SILV.."Akshtd:Games:",Num)
Redis:sadd(SILV.."Akshtd:Games:",Num1)
Redis:sadd(SILV.."Akshtd:Games:",Num2)
Redis:sadd(SILV.."Akshtd:Games:",Num3)
Redis:sadd(SILV.."Akshtd:Games:",Num4)
Redis:sadd(SILV.."Akshtd:Games:",Num5)
Redis:sadd(SILV.."Akshtd:Games:",Num6)
Redis:sadd(SILV.."Akshtd:Games:",Num7)
Redis:sadd(SILV.."Akshtd:Games:",Num8)
Redis:sadd(SILV.."Akshtd:Games:",Num9)
return send(msg.chat_id,msg.id,[[
...
ballanceed = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
if Redis:ttl(SILV.."iiooooo" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(SILV.."iiooooo" .. msg.sender_id.user_id))
...
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(ballanceekkku))
Redis:setex(SILV.."iiooooo" .. msg.sender_id.user_id,900, true)
...
ballanceed = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
if Redis:ttl(SILV.."iioooo" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(SILV.."iioooo" .. msg.sender_id.user_id))
...
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(ballanceekkk))
Redis:setex(SILV.."iioooo" .. msg.sender_id.user_id,1200, true)
...
if text == 'سحب' then
ballanceed = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
if Redis:ttl(SILV.."iioood" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(SILV.."iioood" .. msg.sender_id.user_id))
...
if text == 'حظ' then
ballanceed = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
if Redis:ttl(SILV.."iiooo" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(SILV.."iiooo" .. msg.sender_id.user_id))
...
nsbhad = Redis:get(SILV.."nsbhad"..1) or 50
...
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(ballanceek))
Redis:setex(SILV.."iiooo" .. msg.sender_id.user_id,900, true)
...
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(ballanceekk))
Redis:setex(SILV.."iiooo" .. msg.sender_id.user_id,900, true)
send(msg.chat_id,msg.id, "⇜ للاسف خسرت بالحظ 😬\n⇜ فلوسك قبل ↤ ❲ "..convert_mony.." دولار 💵 ❳\n⇜ رصيدك الان ↤ ❲ `"..convert_mony1.."` دولار 💵 ❳\n✧","md",true)
end
else
send(msg.chat_id,msg.id, "⇜ ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
...
if text == 'تحويل' then
if Redis:ttl(SILV.."tanstime" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(SILV.."tanstime" .. msg.sender_id.user_id))
...
local coniss = coin(UserName)
if not Redis:sismember(SILV.."booob",msg.sender_id.user_id) then
...
Redis:set(SILV.."transn"..msg.sender_id.user_id,coniss)
Redis:setex(SILV.."trans" .. msg.chat_id .. ":" .. msg.sender_id.user_id,60, true)
send(msg.chat_id,msg.id,[[
...
if Redis:get(SILV.."trans" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
cccc = Redis:get(SILV.."boobb"..msg.sender_id.user_id)
uuuu = Redis:get(SILV.."bbobb"..msg.sender_id.user_id)
if text ~= text:match('^(%d+)$') then
Redis:del(SILV.."trans" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
Redis:del(SILV.."transn" .. msg.sender_id.user_id)
...
if Redis:get(SILV.."boballcc"..text) then
local UserNamey = Redis:get(SILV.."transn"..msg.sender_id.user_id)
local ban = bot.getUser(msg.sender_id.user_id)
if ban.first_name then
news = "["..ban.first_name.."](tg://user?id="..ban.id..")"
else
...
local fsvhhh = Redis:get(SILV.."boballid"..text)
...
local fsvhh = Redis:get(SILV.."boballban"..text)
...
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(deccde))
decdecb = Redis:get(SILV.."boob"..fsvhhh) or 0
deccde2 = decdecb + UserNameyy
Redis:set(SILV.."boob"..fsvhhh , math.floor(deccde2))
Redis:setex(SILV.."tanstime" .. msg.sender_id.user_id,1800, true)
send(msg.chat_id,msg.id, "⇜ حوالة صادرة من بنك بوت\n\n⇜ المرسل ↤ "..news.."\n⇜ الحساب رقم ↤ `"..cccc.."`\n⇜ نوع البطاقة ↤ "..uuuu.."\n⇜ المستلم ↤ "..newss.."\n⇜ الحساب رقم ↤ `"..text.."`\n⇜ نوع البطاقة ↤ "..fsvhh.."\n⇜ خصمت 10% رسوم تحويل\n⇜ المبلغ ↤ "..convert_mony.." ريال 💵","md",true)
send(fsvhhh,0, "⌯ حوالة واردة من بنك بوت\n\n⇜ المرسل ↤ "..news.."\n⇜ الحساب رقم ↤ `"..cccc.."`\n⇜ نوع البطاقة ↤ "..uuuu.."\n⇜ المبلغ ↤ "..convert_mony.." ريال 💵","md",true)
Redis:del(SILV.."trans" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
Redis:del(SILV.."transn" .. msg.sender_id.user_id)
else
send(msg.chat_id,msg.id, "⇜ مافيه حساب بنكي كذا","md",true)
...
{
{text = 'توب التفاعل', data = msg.sender_id.user_id..'/tafaillt'}, 
},
{
...
tt = tt:gsub("@[%a%d_]+",'')
tt = tt:gsub("#[%a%d_]+",'')
local doltebank = Redis:get(SILV.."doltebank"..v[2]) or " " or " "
local mony = v[1]
...
zrfee = Redis:get(SILV.."rrfff"..msg.sender_id.user_id) or 0
...
local companys = Redis:smembers(SILV.."companys:")
if #companys == 0 then
...
local Cmony = 0
for k,v in pairs(Redis:smembers(SILV.."company:mem:"..N)) do
local mem_mony = tonumber(Redis:get(SILV.."boob"..v)) or 0
Cmony = Cmony + mem_mony
end
local owner_id = Redis:get(SILV.."companys_owner:"..N)
local Cid = Redis:get(SILV.."companys_id:"..N)
if Redis:sismember(SILV.."booob", owner_id) then
...
return send(msg.chat_id,msg.id, msg_text,"md",false, false, false, false, reply_markup)
end
...
if Redis:ttl(SILV.."iioo" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(SILV.."iioo" .. msg.sender_id.user_id))
return send(msg.chat_id,msg.id,"⇜ من شوي اخذت رشوة استنى "..time.." ","md",true)
end
if Redis:ttl(SILV.."polrsho" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(SILV.."polrsho" .. msg.sender_id.user_id))
...
Redis:set(SILV.."boob"..msg.sender_id.user_id , bakigcj)
send(msg.chat_id,msg.id,"⇜ هذه رشوة بطل زرف "..jjjo.." دولار 💵","md",true)
Redis:setex(SILV.."iioo" .. msg.sender_id.user_id,600, true)
else
Redis:setex(SILV.."polrsho" .. msg.sender_id.user_id,300, true)
...
if Redis:ttl(SILV.."polic" .. msg.sender_id.user_id) >=60 then
local hours = Redis:ttl(SILV.."polic" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id,"⇜ انتا بالسجن 🏤 استنى "..math.floor(hours).." دقائق\n✧","md",true)
end
if Redis:ttl(SILV.."hrame" .. Remsg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(SILV.."hrame" .. Remsg.sender_id.user_id))
...
shkseto = Redis:get(SILV.."shkse"..Remsg.sender_id.user_id)
if shkseto == "طيبة" then
local hrame = math.floor(math.random() * 200) + 1;
local ballanceed = Redis:get(SILV.."boob"..Remsg.sender_id.user_id) or 0
local ballancope = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
zrfne = ballanceed - hrame
zrfnee = ballancope + hrame
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(zrfnee))
Redis:set(SILV.."boob"..Remsg.sender_id.user_id , math.floor(zrfne))
Redis:setex(SILV.."hrame" .. Remsg.sender_id.user_id,600, true)
local zoropeo = Redis:get(SILV.."rrfff"..msg.sender_id.user_id) or 0
zoroprod = zoropeo + hrame
Redis:set(SILV.."rrfff"..msg.sender_id.user_id,zoroprod)
Redis:sadd(SILV.."rrfffid",msg.sender_id.user_id)
local ban = bot.getUser(Remsg.sender_id.user_id)
if ban.first_name then
news = "["..ban.first_name.."](tg://user?id="..ban.id..")"
else
...
Redis:set(SILV.."msrokid"..msg.chat_id..Remsg.sender_id.user_id,Remsg.sender_id.user_id)
Redis:set(SILV.."hrameid"..msg.chat_id..Remsg.sender_id.user_id,msg.sender_id.user_id)
Redis:set(SILV.."balcmsrok"..msg.chat_id..Remsg.sender_id.user_id,hrame)
Redis:setex(SILV.."timehrame"..msg.chat_id..msg.sender_id.user_id,30, true)
bot.deleteMessages(msg.chat_id,{[1]= msg.id})
send(msg.chat_id,0, "⇜ "..news.." في حرامي زرفك "..hrame.." دولار 💵\n⇜ رد عليه بكلمة ( شرطه )\n⇜ معك 30 ثانية\n✧","md",true)
else
local hrame = math.floor(math.random() * 200) + 1;
local ballanceed = Redis:get(SILV.."boob"..Remsg.sender_id.user_id) or 0
local ballancope = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
...
local hrameid = Redis:get(SILV.."hrameid"..msg.chat_id..msg.sender_id.user_id)
shkse = Redis:get(SILV.."shkse"..msg.sender_id.user_id)
if shkse == "شريرة" then
return send(msg.chat_id,msg.id, "⇜ شخصيتك شريرة مايمديك تطلب الشرطة","md",true)
end
if Redis:get(SILV.."timehrame"..msg.chat_id.. hrameid) then
local hours = Redis:ttl(SILV.."timehrame" .. hrameid)
local msrokid = Redis:get(SILV.."msrokid"..msg.chat_id..msg.sender_id.user_id)
local hrameid = Redis:get(SILV.."hrameid"..msg.chat_id..msg.sender_id.user_id)
local balcmsrok = Redis:get(SILV.."balcmsrok"..msg.chat_id..msg.sender_id.user_id) or 0
if tonumber(hrameid) == Remsg.sender_id.user_id and tonumber(msrokid) == msg.sender_id.user_id then
local ballancehrame = Redis:get(SILV.."boob"..hrameid) or 0
local ballancmsrok = Redis:get(SILV.."boob"..msrokid) or 0
ballancehramenow = tonumber(ballancehrame) - tonumber(balcmsrok)
ballancmsroknow = tonumber(ballancmsrok) + tonumber(balcmsrok)
Redis:set(SILV.."boob"..hrameid , ballancehramenow)
Redis:set(SILV.."boob"..msrokid , ballancmsroknow)
...
Redis:setex(SILV.."polic" .. hrameid,600, true)
Redis:del(SILV.."msrokid" ..msg.chat_id..msg.sender_id.user_id) 
Redis:del(SILV.."hrameid" ..msg.chat_id..msg.sender_id.user_id) 
Redis:del(SILV.."balcmsrok" ..msg.chat_id..msg.sender_id.user_id) 
Redis:del(SILV.."timehrame" ..msg.chat_id..msg.sender_id.user_id)
send(msg.chat_id,msg.id,"⇜ كفو مسكته الشرطة 👨‍✈️\n⇜ الحرامي : "..news.."\n⇜ تم اعادة فلوسك : "..tonumber(balcmsrok).." دولار 💵\n⇜ سيتم سجن الحرامي\n✧","md",true)
else
...
if text == "راتب مبرمج" then
if not msg.ControllerBot then
return send(msg_chat_id,msg_id,'\n• الامر يخص ( '..Controller_Num(1)..' ) ',"md",true)
end
    F = '10000000000000'
    trakos = " the art of making your money work for you. . - المبرمج"
local ballancee = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
local ratpep = ballancee + 10000000000000
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(ratpep))
local ballancee = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
local convert_mony = string.format("%.0f",ballancee)
local teex = "اشعار ايداع "..trakos.."\nالمبلغ : "..F.." دولار 💸\nوظيفتك : مالك البوت وعلى راسي \nنوع العملية : اضافة الاستحقاق\nرصيدك الآن : "..convert_mony.." دولار 💸"
send(msg.chat_id,msg.id,teex,"md",true)
end
...
if Redis:ttl(SILV.."iiioo" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(SILV.."iiioo" .. msg.sender_id.user_id))
...
local ballancee = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
shkse = Redis:get(SILV.."shkse"..msg.sender_id.user_id)
ratbinc = Redis:get(SILV.."ratbinc"..msg.sender_id.user_id) or 1
ratbtrans = Redis:get(SILV.."ratbtrans"..msg.sender_id.user_id) or 1
if shkse == "طيبة" then
...
local ballancee = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
local convert_mony = string.format("%.0f",ballancee)
Redis:setex(SILV.."iiioo" .. msg.sender_id.user_id,600, true)
Redis:incrby(SILV.."ratbinc"..msg.sender_id.user_id,1)
ratbinc = Redis:get(SILV.."ratbinc"..msg.sender_id.user_id)
...
Redis:set(SILV.."ratbinc"..msg.sender_id.user_id,300)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 500000 دولار 💵\n⇜ وظيفتك : ملك 👑\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : `"..convert_mony.."` دولار 💵\n✧","md",true)
end
...
Redis:setex(SILV.."iiioo" .. msg.sender_id.user_id,600, true)
Redis:incrby(SILV.."ratbinc"..msg.sender_id.user_id,1)
ratbinc = Redis:get(SILV.."ratbinc"..msg.sender_id.user_id) or 0
if tonumber(ratbinc) == 270 or tonumber(ratbinc) == 271 then
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 200000 دولار 💵\n⇜ وظيفتك : امير 🤵‍♂️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." دولار 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(SILV.."ratbinc"..msg.sender_id.user_id,270)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 200000 دولار 💵\n⇜ وظيفتك : امير 🤵‍♂️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." دولار 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 100000 دولار 💵\n⇜ وظيفتك : وزير 🤵‍♂️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." دولار 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(SILV.."ratbinc"..msg.sender_id.user_id,240)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 100000 دولار 💵\n⇜ وظيفتك : وزير 🤵‍♂️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." دولار 💵\n✧","md",true)
end
...
Redis:set(SILV.."ratbinc"..msg.sender_id.user_id,210)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 70000 دولار 💵\n⇜ وظيفتك : بزنس مان كبير 💸\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." دولار 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 40000 دولار 💵\n⇜ وظيفتك : تاجر صغير 💰\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." دولار 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(SILV.."ratbinc"..msg.sender_id.user_id,180)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 40000 دولار 💵\n⇜ وظيفتك : تاجر صغير 💰\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." دولار 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 25000 دولار 💵\n⇜ وظيفتك : طيار 👨‍✈️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." دولار 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(SILV.."ratbinc"..msg.sender_id.user_id,150)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 25000 دولار 💵\n⇜ وظيفتك : طيار 👨‍✈️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." دولار 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 18000 دولار 💵\n⇜ وظيفتك : دكتور 👨‍⚕️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." دولار 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(SILV.."ratbinc"..msg.sender_id.user_id,120)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 18000 دولار 💵\n⇜ وظيفتك : دكتور 👨‍⚕️\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." دولار 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 9000 دولار 💵\n⇜ وظيفتك : صيدلي 👨‍🔬\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." دولار 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(SILV.."ratbinc"..msg.sender_id.user_id,90)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 9000 دولار 💵\n⇜ وظيفتك : صيدلي 👨‍🔬\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." دولار 💵\n✧","md",true)
end
...
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 2500 دولار 💵\n⇜ وظيفتك : نجار 👨‍🔧\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." دولار 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
Redis:set(SILV.."ratbinc"..msg.sender_id.user_id,60)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 2500 دولار 💵\n⇜ وظيفتك : نجار 👨‍🔧\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." دولار 💵\n✧","md",true)
end
...
Redis:set(SILV.."ratbinc"..msg.sender_id.user_id,30)
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 500 دولار 💵\n⇜ وظيفتك : قروي 👨‍🌾\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." دولار 💵\n\nتستطيع الان تطوير راتبك ارسل ( `تطوير راتب` )\n✧","md",true)
else
send(msg.chat_id,msg.id,"⌯ اشعار ايداع "..neews.."\n\n⇜ المبلغ : 500 دولار 💵\n⇜ وظيفتك : قروي 👨‍🌾\n⇜ نوع العملية : اضافة راتب\n⇜ تطوير الراتب : "..tonumber(ratbinc).."\n⇜ رصيدك الان : "..convert_mony.." دولار 💵\n✧","md",true)
end
...
return send(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 1000000000 دولار 💵","md",true)
end
Redis:del(SILV.."ratbtrans"..msg.sender_id.user_id)
Redis:set(SILV.."ratbtrans"..msg.sender_id.user_id,10)
nowbalc = tonumber(ballancee) - 1000000000
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(nowbalc))
local convert_mony = string.format("%.0f",nowbalc)
send(msg.chat_id,msg.id,"⌯ اشعار تطوير راتب\n\n⇜ المبلغ : 1000000000 دولار 💵\n⇜ اصبحت وظيفتك : ملك 👑\n⇜ رصيدك الان : "..convert_mony.." دولار 💵\n✧","md",true)
elseif tonumber(ratbinc) == 240 then
if tonumber(ballanceed) < 200000000 then
return send(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 200000000 دولار 💵","md",true)
end
Redis:del(SILV.."ratbtrans"..msg.sender_id.user_id)
Redis:set(SILV.."ratbtrans"..msg.sender_id.user_id,9)
nowbalc = tonumber(ballancee) - 200000000
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(nowbalc))
local convert_mony = string.format("%.0f",nowbalc)
send(msg.chat_id,msg.id,"⌯ اشعار تطوير راتب\n\n⇜ المبلغ : 200000000 دولار 💵\n⇜ اصبحت وظيفتك : امير 🤵\n⇜ رصيدك الان : "..convert_mony.." دولار 💵\n✧","md",true)
elseif tonumber(ratbinc) == 210 then
if tonumber(ballanceed) < 30000000 then
return send(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 30000000 دولار 💵","md",true)
end
Redis:del(SILV.."ratbtrans"..msg.sender_id.user_id)
Redis:set(SILV.."ratbtrans"..msg.sender_id.user_id,8)
nowbalc = tonumber(ballancee) - 30000000
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(nowbalc))
local convert_mony = string.format("%.0f",nowbalc)
send(msg.chat_id,msg.id,"⌯ اشعار تطوير راتب\n\n⇜ المبلغ : 30000000 دولار 💵\n⇜ اصبحت وظيفتك : وزير 🤵\n⇜ رصيدك الان : "..convert_mony.." دولار 💵\n✧","md",true)
elseif tonumber(ratbinc) == 180 then
if tonumber(ballanceed) < 1000000 then
return send(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 1000000 دولار 💵","md",true)
end
Redis:del(SILV.."ratbtrans"..msg.sender_id.user_id)
Redis:set(SILV.."ratbtrans"..msg.sender_id.user_id,7)
nowbalc = tonumber(ballancee) - 1000000
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(nowbalc))
local convert_mony = string.format("%.0f",nowbalc)
send(msg.chat_id,msg.id,"⌯ اشعار تطوير راتب\n\n⇜ المبلغ : 1000000 دولار 💵\n⇜ اصبحت وظيفتك : بزنس مان كبير 💸\n⇜ رصيدك الان : "..convert_mony.." دولار 💵\n✧","md",true)
elseif tonumber(ratbinc) == 150 then
if tonumber(ballanceed) < 300000 then
return send(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 300000 دولار 💵","md",true)
end
Redis:del(SILV.."ratbtrans"..msg.sender_id.user_id)
Redis:set(SILV.."ratbtrans"..msg.sender_id.user_id,6)
...
return send(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 120000 دولار 💵","md",true)
end
Redis:del(SILV.."ratbtrans"..msg.sender_id.user_id)
Redis:set(SILV.."ratbtrans"..msg.sender_id.user_id,5)
...
return send(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 80000 دولار 💵","md",true)
end
Redis:del(SILV.."ratbtrans"..msg.sender_id.user_id)
Redis:set(SILV.."ratbtrans"..msg.sender_id.user_id,4)
...
return send(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 30000 دولار 💵","md",true)
end
Redis:del(SILV.."ratbtrans"..msg.sender_id.user_id)
Redis:set(SILV.."ratbtrans"..msg.sender_id.user_id,3)
...
return send(msg.chat_id,msg.id, "⇜ مايمديك تطور راتبك تحتاج مبلغ 3000 دولار 💵","md",true)
end
Redis:del(SILV.."ratbtrans"..msg.sender_id.user_id)
Redis:set(SILV.."ratbtrans"..msg.sender_id.user_id,2)
...
if Redis:ttl(SILV.."attack" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(SILV.."attack" .. msg.sender_id.user_id))
return send(msg.chat_id,msg.id,"⇜ خسرت بأخر معركة استنى "..time.." ","md",true)
end
if Redis:ttl(SILV.."defen" .. Remsg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(SILV.."defen" .. Remsg.sender_id.user_id))
return send(msg.chat_id,msg.id,"⇜ الخصم خسر بأخر معركة\n⇜ يمديك تهاجمه بعد "..time.." ","md",true)
end
if Redis:sismember(SILV.."booob",Remsg.sender_id.user_id) then
ballancope = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
ballanceed = Redis:get(SILV.."boob"..Remsg.sender_id.user_id) or 0
if tonumber(ballancope) < 100000 then
return send(msg.chat_id,msg.id, "⇜ مايمديك تهجم فلوسك اقل من 100000 دولار 💵","md",true)
end
if tonumber(ballanceed) < 100000 then
return send(msg.chat_id,msg.id, "⇜ مايمديك تهجم عليه فلوسه اقل من 100000 دولار 💵","md",true)
end
if tonumber(coniss) < 9999 then
return send(msg.chat_id,msg.id, "⇜ الحد الادنى المسموح هو 10000 دولار 💵\n✧","md",true)
end
...
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(zrfne))
Redis:set(SILV.."boob"..Remsg.sender_id.user_id , math.floor(zrfnee))
Redis:setex(SILV.."defen" .. Remsg.sender_id.user_id,1800, true)
Redis:set(SILV.."numattack"..msg.sender_id.user_id , math.floor(numattackk))
...
Redis:setex(SILV.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id,60, true)
send(msg.chat_id,msg.id,[[
...
if text == "سيارات" and Redis:get(SILV.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
Redis:del(SILV.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
send(msg.chat_id,msg.id,[[
...
if text == "طيارات" and Redis:get(SILV.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
Redis:del(SILV.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
send(msg.chat_id,msg.id,[[
...
if text == "عقارات" and Redis:get(SILV.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
Redis:del(SILV.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
send(msg.chat_id,msg.id,[[
...
if text == "مجوهرات" and Redis:get(SILV.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
Redis:del(SILV.."marad" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
send(msg.chat_id,msg.id,[[
...
ballance = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
...
local mgrmasname = Redis:get(SILV.."mgrmasname"..msg.sender_id.user_id)
local mgrmasprice = Redis:get(SILV.."mgrmasprice"..msg.sender_id.user_id) or 0
local mgrmasnum = Redis:get(SILV.."mgrmasnum"..msg.sender_id.user_id) or 0
local mgrmasnow = tonumber(mgrmasnum) + tonumber(coniss)
Redis:set(SILV.."mgrmasnum"..msg.sender_id.user_id , mgrmasnow)
masnamed = "ماسه"
Redis:set(SILV.."mgrmasname"..msg.sender_id.user_id , masnamed)
Redis:set(SILV.."mgrmasprice"..msg.sender_id.user_id , 1000000)
totalypalice = tonumber(ballance) - tonumber(masmgr)
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
...
local mgrkldname = Redis:get(SILV.."mgrkldname"..msg.sender_id.user_id)
local mgrkldprice = Redis:get(SILV.."mgrkldprice"..msg.sender_id.user_id) or 0
local mgrkldnum = Redis:get(SILV.."mgrkldnum"..msg.sender_id.user_id) or 0
local mgrkldnow = tonumber(mgrkldnum) + tonumber(coniss)
Redis:set(SILV.."mgrkldnum"..msg.sender_id.user_id , mgrkldnow)
kldnamed = "قلاده"
Redis:set(SILV.."mgrkldname"..msg.sender_id.user_id , kldnamed)
Redis:set(SILV.."mgrkldprice"..msg.sender_id.user_id , 500000)
...
local mgrswrname = Redis:get(SILV.."mgrswrname"..msg.sender_id.user_id)
local mgrswrprice = Redis:get(SILV.."mgrswrprice"..msg.sender_id.user_id) or 0
local mgrswrnum = Redis:get(SILV.."mgrswrnum"..msg.sender_id.user_id) or 0
local mgrswrnow = tonumber(mgrswrnum) + tonumber(coniss)
Redis:set(SILV.."mgrswrnum"..msg.sender_id.user_id , mgrswrnow)
swrnamed = "سوار"
Redis:set(SILV.."mgrswrname"..msg.sender_id.user_id , swrnamed)
Redis:set(SILV.."mgrswrprice"..msg.sender_id.user_id , 200000)
...
local mgrktmname = Redis:get(SILV.."mgrktmname"..msg.sender_id.user_id)
local mgrktmprice = Redis:get(SILV.."mgrktmprice"..msg.sender_id.user_id) or 0
local mgrktmnum = Redis:get(SILV.."mgrktmnum"..msg.sender_id.user_id) or 0
local mgrktmnow = tonumber(mgrktmnum) + tonumber(coniss)
Redis:set(SILV.."mgrktmnum"..msg.sender_id.user_id , mgrktmnow)
ktmnamed = "خاتم"
Redis:set(SILV.."mgrktmname"..msg.sender_id.user_id , ktmnamed)
Redis:set(SILV.."mgrktmprice"..msg.sender_id.user_id , 50000)
...
Redis:set(SILV.."boob"..msg.sender_id.user_id , totalypalice)
local convert_mony = string.format("%.0f",math.floor(totalypalice))
local mgrmasnum = Redis:get(SILV.."mgrmasnum"..msg.sender_id.user_id) or 0
if tonumber(mgrmasnum) == 0 then
Redis:del(SILV.."mgrmasname"..msg.sender_id.user_id)
...
if Redis:ttl(SILV.."giftmmt" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(SILV.."giftmmt" .. msg.sender_id.user_id))
...
local mgrmasnow = tonumber(mgrmasnum) - tonumber(coniss)
Redis:set(SILV.."mgrmasnum"..msg.sender_id.user_id , mgrmasnow)
local mgrmasnumm = Redis:get(SILV.."mgrmasnum"..Remsg.sender_id.user_id) or 0
local mgrmasnoww = tonumber(mgrmasnumm) + tonumber(coniss)
Redis:set(SILV.."mgrmasnum"..Remsg.sender_id.user_id , mgrmasnoww)
masnamed = "ماسه"
Redis:set(SILV.."mgrmasname"..Remsg.sender_id.user_id,masnamed)
local mgrmasnum = Redis:get(SILV.."mgrmasnum"..msg.sender_id.user_id) or 0
if tonumber(mgrmasnum) == 0 then
Redis:del(SILV.."mgrmasname"..msg.sender_id.user_id)
Redis:del(SILV.."mgrmasnum"..msg.sender_id.user_id)
end
Redis:setex(SILV.."giftmmt" .. msg.sender_id.user_id,1800, true)
...
local mgrkldnow = tonumber(mgrkldnum) - tonumber(coniss)
Redis:set(SILV.."mgrkldnum"..msg.sender_id.user_id , mgrkldnow)
local mgrkldnumm = Redis:get(SILV.."mgrkldnum"..Remsg.sender_id.user_id) or 0
local mgrkldnoww = tonumber(mgrkldnumm) + tonumber(coniss)
Redis:set(SILV.."mgrkldnum"..Remsg.sender_id.user_id , mgrkldnoww)
kldnamed = "قلاده"
Redis:set(SILV.."mgrkldname"..Remsg.sender_id.user_id,kldnamed)
local mgrkldnum = Redis:get(SILV.."mgrkldnum"..msg.sender_id.user_id) or 0
if tonumber(mgrkldnum) == 0 then
Redis:del(SILV.."mgrkldname"..msg.sender_id.user_id)
Redis:del(SILV.."mgrkldnum"..msg.sender_id.user_id)
...
local mgrswrnow = tonumber(mgrswrnum) - tonumber(coniss)
Redis:set(SILV.."mgrswrnum"..msg.sender_id.user_id , mgrswrnow)
local mgrswrnumm = Redis:get(SILV.."mgrswrnum"..Remsg.sender_id.user_id) or 0
local mgrswrnoww = tonumber(mgrswrnumm) + tonumber(coniss)
Redis:set(SILV.."mgrswrnum"..Remsg.sender_id.user_id , mgrswrnoww)
swrnamed = "سوار"
Redis:set(SILV.."mgrswrname"..Remsg.sender_id.user_id,swrnamed)
local mgrswrnum = Redis:get(SILV.."mgrswrnum"..msg.sender_id.user_id) or 0
if tonumber(mgrswrnum) == 0 then
Redis:del(SILV.."mgrswrname"..msg.sender_id.user_id)
Redis:del(SILV.."mgrswrnum"..msg.sender_id.user_id)
...
local mgrktmnow = tonumber(mgrktmnum) - tonumber(coniss)
Redis:set(SILV.."mgrktmnum"..msg.sender_id.user_id , mgrktmnow)
local mgrktmnumm = Redis:get(SILV.."mgrktmnum"..Remsg.sender_id.user_id) or 0
local mgrktmnoww = tonumber(mgrktmnumm) + tonumber(coniss)
Redis:set(SILV.."mgrktmnum"..Remsg.sender_id.user_id , mgrktmnoww)
ktmnamed = "خاتم"
Redis:set(SILV.."mgrktmname"..Remsg.sender_id.user_id,ktmnamed)
local mgrktmnum = Redis:get(SILV.."mgrktmnum"..msg.sender_id.user_id) or 0
if tonumber(mgrktmnum) == 0 then
Redis:del(SILV.."mgrktmname"..msg.sender_id.user_id)
Redis:del(SILV.."mgrktmnum"..msg.sender_id.user_id)
...
local akrksrname = Redis:get(SILV.."akrksrname"..msg.sender_id.user_id)
local akrksrprice = Redis:get(SILV.."akrksrprice"..msg.sender_id.user_id) or 0
local akrksrnum = Redis:get(SILV.."akrksrnum"..msg.sender_id.user_id) or 0
local akrksrnow = tonumber(akrksrnum) + tonumber(coniss)
Redis:set(SILV.."akrksrnum"..msg.sender_id.user_id , akrksrnow)
ksrnamed = "قصر"
Redis:set(SILV.."akrksrname"..msg.sender_id.user_id , ksrnamed)
Redis:set(SILV.."akrksrprice"..msg.sender_id.user_id , 1000000)
...
local akrfelname = Redis:get(SILV.."akrfelname"..msg.sender_id.user_id)
local akrfelprice = Redis:get(SILV.."akrfelprice"..msg.sender_id.user_id) or 0
local akrfelnum = Redis:get(SILV.."akrfelnum"..msg.sender_id.user_id) or 0
local akrfelnow = tonumber(akrfelnum) + tonumber(coniss)
Redis:set(SILV.."akrfelnum"..msg.sender_id.user_id , akrfelnow)
felnamed = "فيلا"
Redis:set(SILV.."akrfelname"..msg.sender_id.user_id , felnamed)
Redis:set(SILV.."akrfelprice"..msg.sender_id.user_id , 500000)
...
local akrmnzname = Redis:get(SILV.."akrmnzname"..msg.sender_id.user_id)
local akrmnzprice = Redis:get(SILV.."akrmnzprice"..msg.sender_id.user_id) or 0
local akrmnznum = Redis:get(SILV.."akrmnznum"..msg.sender_id.user_id) or 0
local akrmnznow = tonumber(akrmnznum) + tonumber(coniss)
Redis:set(SILV.."akrmnznum"..msg.sender_id.user_id , akrmnznow)
mnznamed = "منزل"
Redis:set(SILV.."akrmnzname"..msg.sender_id.user_id , mnznamed)
Redis:set(SILV.."akrmnzprice"..msg.sender_id.user_id , 200000)
...
local akrksrnow = tonumber(akrksrnum) - tonumber(coniss)
Redis:set(SILV.."akrksrnum"..msg.sender_id.user_id , akrksrnow)
local akrksrnumm = Redis:get(SILV.."akrksrnum"..Remsg.sender_id.user_id) or 0
local akrksrnoww = tonumber(akrksrnumm) + tonumber(coniss)
Redis:set(SILV.."akrksrnum"..Remsg.sender_id.user_id , akrksrnoww)
ksrnamed = "قصر"
Redis:set(SILV.."akrksrname"..Remsg.sender_id.user_id,ksrnamed)
local akrksrnum = Redis:get(SILV.."akrksrnum"..msg.sender_id.user_id) or 0
if tonumber(akrksrnum) == 0 then
Redis:del(SILV.."akrksrname"..msg.sender_id.user_id)
Redis:del(SILV.."akrksrnum"..msg.sender_id.user_id)
...
local akrfelnow = tonumber(akrfelnum) - tonumber(coniss)
Redis:set(SILV.."akrfelnum"..msg.sender_id.user_id , akrfelnow)
local akrfelnumm = Redis:get(SILV.."akrfelnum"..Remsg.sender_id.user_id) or 0
local akrfelnoww = tonumber(akrfelnumm) + tonumber(coniss)
Redis:set(SILV.."akrfelnum"..Remsg.sender_id.user_id , akrfelnoww)
felnamed = "فيلا"
Redis:set(SILV.."akrfelname"..Remsg.sender_id.user_id,felnamed)
local akrfelnum = Redis:get(SILV.."akrfelnum"..msg.sender_id.user_id) or 0
if tonumber(akrfelnum) == 0 then
Redis:del(SILV.."akrfelname"..msg.sender_id.user_id)
Redis:del(SILV.."akrfelnum"..msg.sender_id.user_id)
...
local akrmnznow = tonumber(akrmnznum) - tonumber(coniss)
Redis:set(SILV.."akrmnznum"..msg.sender_id.user_id , akrmnznow)
local akrmnznumm = Redis:get(SILV.."akrmnznum"..Remsg.sender_id.user_id) or 0
local akrmnznoww = tonumber(akrmnznumm) + tonumber(coniss)
Redis:set(SILV.."akrmnznum"..Remsg.sender_id.user_id , akrmnznoww)
mnznamed = "منزل"
Redis:set(SILV.."akrmnzname"..Remsg.sender_id.user_id,mnznamed)
local akrmnznum = Redis:get(SILV.."akrmnznum"..msg.sender_id.user_id) or 0
if tonumber(akrmnznum) == 0 then
Redis:del(SILV.."akrmnzname"..msg.sender_id.user_id)
Redis:del(SILV.."akrmnznum"..msg.sender_id.user_id)
...
local airshbhname = Redis:get(SILV.."airshbhname"..msg.sender_id.user_id)
local airshbhprice = Redis:get(SILV.."airshbhprice"..msg.sender_id.user_id) or 0
local airshbhnum = Redis:get(SILV.."airshbhnum"..msg.sender_id.user_id) or 0
local airshbhnow = tonumber(airshbhnum) + tonumber(coniss)
Redis:set(SILV.."airshbhnum"..msg.sender_id.user_id , airshbhnow)
shbhnamed = "شبح"
Redis:set(SILV.."airshbhname"..msg.sender_id.user_id , shbhnamed)
Redis:set(SILV.."airshbhprice"..msg.sender_id.user_id , 1000000000)
...
local airsfarname = Redis:get(SILV.."airsfarname"..msg.sender_id.user_id)
local airsfarprice = Redis:get(SILV.."airsfarprice"..msg.sender_id.user_id) or 0
local airsfarnum = Redis:get(SILV.."airsfarnum"..msg.sender_id.user_id) or 0
local airsfarnow = tonumber(airsfarnum) + tonumber(coniss)
Redis:set(SILV.."airsfarnum"..msg.sender_id.user_id , airsfarnow)
sfarnamed = "سفر"
Redis:set(SILV.."airsfarname"..msg.sender_id.user_id , sfarnamed)
Redis:set(SILV.."airsfarprice"..msg.sender_id.user_id , 500000000)
...
local airkhasname = Redis:get(SILV.."airkhasname"..msg.sender_id.user_id)
local airkhasprice = Redis:get(SILV.."airkhasprice"..msg.sender_id.user_id) or 0
local airkhasnum = Redis:get(SILV.."airkhasnum"..msg.sender_id.user_id) or 0
local airkhasnow = tonumber(airkhasnum) + tonumber(coniss)
Redis:set(SILV.."airkhasnum"..msg.sender_id.user_id , airkhasnow)
khasnamed = "خاصه"
Redis:set(SILV.."airkhasname"..msg.sender_id.user_id , khasnamed)
Redis:set(SILV.."airkhasprice"..msg.sender_id.user_id , 200000000)
...
local airshbhnow = tonumber(airshbhnum) - tonumber(coniss)
Redis:set(SILV.."airshbhnum"..msg.sender_id.user_id , airshbhnow)
local airshbhnumm = Redis:get(SILV.."airshbhnum"..Remsg.sender_id.user_id) or 0
local airshbhnoww = tonumber(airshbhnumm) + tonumber(coniss)
Redis:set(SILV.."airshbhnum"..Remsg.sender_id.user_id , airshbhnoww)
shbhnamed = "شبح"
Redis:set(SILV.."airshbhname"..Remsg.sender_id.user_id,shbhnamed)
local airshbhnum = Redis:get(SILV.."airshbhnum"..msg.sender_id.user_id) or 0
if tonumber(airshbhnum) == 0 then
Redis:del(SILV.."airshbhname"..msg.sender_id.user_id)
Redis:del(SILV.."airshbhnum"..msg.sender_id.user_id)
...
local airsfarnow = tonumber(airsfarnum) - tonumber(coniss)
Redis:set(SILV.."airsfarnum"..msg.sender_id.user_id , airsfarnow)
local airsfarnumm = Redis:get(SILV.."airsfarnum"..Remsg.sender_id.user_id) or 0
local airsfarnoww = tonumber(airsfarnumm) + tonumber(coniss)
Redis:set(SILV.."airsfarnum"..Remsg.sender_id.user_id , airsfarnoww)
sfarnamed = "سفر"
Redis:set(SILV.."airsfarname"..Remsg.sender_id.user_id,sfarnamed)
local airsfarnum = Redis:get(SILV.."airsfarnum"..msg.sender_id.user_id) or 0
if tonumber(airsfarnum) == 0 then
Redis:del(SILV.."airsfarname"..msg.sender_id.user_id)
Redis:del(SILV.."airsfarnum"..msg.sender_id.user_id)
...
local airkhasnow = tonumber(airkhasnum) - tonumber(coniss)
Redis:set(SILV.."airkhasnum"..msg.sender_id.user_id , airkhasnow)
local airkhasnumm = Redis:get(SILV.."airkhasnum"..Remsg.sender_id.user_id) or 0
local airkhasnoww = tonumber(airkhasnumm) + tonumber(coniss)
Redis:set(SILV.."airkhasnum"..Remsg.sender_id.user_id , airkhasnoww)
khasnamed = "خاصه"
Redis:set(SILV.."airkhasname"..Remsg.sender_id.user_id,khasnamed)
local airkhasnum = Redis:get(SILV.."airkhasnum"..msg.sender_id.user_id) or 0
if tonumber(airkhasnum) == 0 then
Redis:del(SILV.."airkhasname"..msg.sender_id.user_id)
Redis:del(SILV.."airkhasnum"..msg.sender_id.user_id)
...
local carrangname = Redis:get(SILV.."carrangname"..msg.sender_id.user_id)
local carrangprice = Redis:get(SILV.."carrangprice"..msg.sender_id.user_id) or 0
local carrangnum = Redis:get(SILV.."carrangnum"..msg.sender_id.user_id) or 0
local carrangnow = tonumber(carrangnum) + tonumber(coniss)
Redis:set(SILV.."carrangnum"..msg.sender_id.user_id , carrangnow)
rangnamed = "فيلار"
Redis:set(SILV.."carrangname"..msg.sender_id.user_id , rangnamed)
Redis:set(SILV.."carrangprice"..msg.sender_id.user_id , 10000000)
...
local caraccename = Redis:get(SILV.."caraccename"..msg.sender_id.user_id)
local caracceprice = Redis:get(SILV.."caracceprice"..msg.sender_id.user_id) or 0
local caraccenum = Redis:get(SILV.."caraccenum"..msg.sender_id.user_id) or 0
local caraccenow = tonumber(caraccenum) + tonumber(coniss)
Redis:set(SILV.."caraccenum"..msg.sender_id.user_id , caraccenow)
accenamed = "اكسنت"
Redis:set(SILV.."caraccename"..msg.sender_id.user_id , accenamed)
Redis:set(SILV.."caracceprice"..msg.sender_id.user_id , 9000000)
...
local carcamrname = Redis:get(SILV.."carcamrname"..msg.sender_id.user_id)
local carcamrprice = Redis:get(SILV.."carcamrprice"..msg.sender_id.user_id) or 0
local carcamrnum = Redis:get(SILV.."carcamrnum"..msg.sender_id.user_id) or 0
local carcamrnow = tonumber(carcamrnum) + tonumber(coniss)
Redis:set(SILV.."carcamrnum"..msg.sender_id.user_id , carcamrnow)
camrnamed = "كامري"
Redis:set(SILV.."carcamrname"..msg.sender_id.user_id , camrnamed)
Redis:set(SILV.."carcamrprice"..msg.sender_id.user_id , 8000000)
...
local caralntrname = Redis:get(SILV.."caralntrname"..msg.sender_id.user_id)
local caralntrprice = Redis:get(SILV.."caralntrprice"..msg.sender_id.user_id) or 0
local caralntrnum = Redis:get(SILV.."caralntrnum"..msg.sender_id.user_id) or 0
local caralntrnow = tonumber(caralntrnum) + tonumber(coniss)
Redis:set(SILV.."caralntrnum"..msg.sender_id.user_id , caralntrnow)
alntrnamed = "النترا"
Redis:set(SILV.."caralntrname"..msg.sender_id.user_id , alntrnamed)
Redis:set(SILV.."caralntrprice"..msg.sender_id.user_id , 7000000)
...
local carhilxname = Redis:get(SILV.."carhilxname"..msg.sender_id.user_id)
local carhilxprice = Redis:get(SILV.."carhilxprice"..msg.sender_id.user_id) or 0
local carhilxnum = Redis:get(SILV.."carhilxnum"..msg.sender_id.user_id) or 0
local carhilxnow = tonumber(carhilxnum) + tonumber(coniss)
Redis:set(SILV.."carhilxnum"..msg.sender_id.user_id , carhilxnow)
hilxnamed = "هايلكس"
Redis:set(SILV.."carhilxname"..msg.sender_id.user_id , hilxnamed)
Redis:set(SILV.."carhilxprice"..msg.sender_id.user_id , 6000000)
...
local carsonaname = Redis:get(SILV.."carsonaname"..msg.sender_id.user_id)
local carsonaprice = Redis:get(SILV.."carsonaprice"..msg.sender_id.user_id) or 0
local carsonanum = Redis:get(SILV.."carsonanum"..msg.sender_id.user_id) or 0
local carsonanow = tonumber(carsonanum) + tonumber(coniss)
Redis:set(SILV.."carsonanum"..msg.sender_id.user_id , carsonanow)
sonanamed = "سوناتا"
Redis:set(SILV.."carsonaname"..msg.sender_id.user_id , sonanamed)
Redis:set(SILV.."carsonaprice"..msg.sender_id.user_id , 5000000)
...
local carcoroname = Redis:get(SILV.."carcoroname"..msg.sender_id.user_id)
local carcoroprice = Redis:get(SILV.."carcoroprice"..msg.sender_id.user_id) or 0
local carcoronum = Redis:get(SILV.."carcoronum"..msg.sender_id.user_id) or 0
local carcoronow = tonumber(carcoronum) + tonumber(coniss)
Redis:set(SILV.."carcoronum"..msg.sender_id.user_id , carcoronow)
coronamed = "كورولا"
Redis:set(SILV.."carcoroname"..msg.sender_id.user_id , coronamed)
Redis:set(SILV.."carcoroprice"..msg.sender_id.user_id , 4000000)
...
local carrangnow = tonumber(carrangnum) - tonumber(coniss)
Redis:set(SILV.."carrangnum"..msg.sender_id.user_id , carrangnow)
local carrangnumm = Redis:get(SILV.."carrangnum"..Remsg.sender_id.user_id) or 0
local carrangnoww = tonumber(carrangnumm) + tonumber(coniss)
Redis:set(SILV.."carrangnum"..Remsg.sender_id.user_id , carrangnoww)
rangnamed = "فيلار"
Redis:set(SILV.."carrangname"..Remsg.sender_id.user_id,rangnamed)
local carrangnum = Redis:get(SILV.."carrangnum"..msg.sender_id.user_id) or 0
if tonumber(carrangnum) == 0 then
Redis:del(SILV.."carrangname"..msg.sender_id.user_id)
Redis:del(SILV.."carrangnum"..msg.sender_id.user_id)
...
local caraccenow = tonumber(caraccenum) - tonumber(coniss)
Redis:set(SILV.."caraccenum"..msg.sender_id.user_id , caraccenow)
local caraccenumm = Redis:get(SILV.."caraccenum"..Remsg.sender_id.user_id) or 0
local caraccenoww = tonumber(caraccenumm) + tonumber(coniss)
Redis:set(SILV.."caraccenum"..Remsg.sender_id.user_id , caraccenoww)
accenamed = "اكسنت"
Redis:set(SILV.."caraccename"..Remsg.sender_id.user_id,accenamed)
local caraccenum = Redis:get(SILV.."caraccenum"..msg.sender_id.user_id) or 0
if tonumber(caraccenum) == 0 then
Redis:del(SILV.."caraccename"..msg.sender_id.user_id)
Redis:del(SILV.."caraccenum"..msg.sender_id.user_id)
...
local carcamrnow = tonumber(carcamrnum) - tonumber(coniss)
Redis:set(SILV.."carcamrnum"..msg.sender_id.user_id , carcamrnow)
local carcamrnumm = Redis:get(SILV.."carcamrnum"..Remsg.sender_id.user_id) or 0
local carcamrnoww = tonumber(carcamrnumm) + tonumber(coniss)
Redis:set(SILV.."carcamrnum"..Remsg.sender_id.user_id , carcamrnoww)
camrnamed = "كامري"
Redis:set(SILV.."carcamrname"..Remsg.sender_id.user_id,camrnamed)
local carcamrnum = Redis:get(SILV.."carcamrnum"..msg.sender_id.user_id) or 0
if tonumber(carcamrnum) == 0 then
Redis:del(SILV.."carcamrname"..msg.sender_id.user_id)
Redis:del(SILV.."carcamrnum"..msg.sender_id.user_id)
...
local carhilxnow = tonumber(carhilxnum) - tonumber(coniss)
Redis:set(SILV.."carhilxnum"..msg.sender_id.user_id , carhilxnow)
local carhilxnumm = Redis:get(SILV.."carhilxnum"..Remsg.sender_id.user_id) or 0
local carhilxnoww = tonumber(carhilxnumm) + tonumber(coniss)
Redis:set(SILV.."carhilxnum"..Remsg.sender_id.user_id , carhilxnoww)
hilxnamed = "هايلكس"
Redis:set(SILV.."carhilxname"..Remsg.sender_id.user_id,hilxnamed)
local carhilxnum = Redis:get(SILV.."carhilxnum"..msg.sender_id.user_id) or 0
if tonumber(carhilxnum) == 0 then
Redis:del(SILV.."carhilxname"..msg.sender_id.user_id)
Redis:del(SILV.."carhilxnum"..msg.sender_id.user_id)
...
local caralntrnow = tonumber(caralntrnum) - tonumber(coniss)
Redis:set(SILV.."caralntrnum"..msg.sender_id.user_id , caralntrnow)
local caralntrnumm = Redis:get(SILV.."caralntrnum"..Remsg.sender_id.user_id) or 0
local caralntrnoww = tonumber(caralntrnumm) + tonumber(coniss)
Redis:set(SILV.."caralntrnum"..Remsg.sender_id.user_id , caralntrnoww)
alntrnamed = "النترا"
Redis:set(SILV.."caralntrname"..Remsg.sender_id.user_id,alntrnamed)
local caralntrnum = Redis:get(SILV.."caralntrnum"..msg.sender_id.user_id) or 0
if tonumber(caralntrnum) == 0 then
Redis:del(SILV.."caralntrname"..msg.sender_id.user_id)
Redis:del(SILV.."caralntrnum"..msg.sender_id.user_id)
...
local carsonanow = tonumber(carsonanum) - tonumber(coniss)
Redis:set(SILV.."carsonanum"..msg.sender_id.user_id , carsonanow)
local carsonanumm = Redis:get(SILV.."carsonanum"..Remsg.sender_id.user_id) or 0
local carsonanoww = tonumber(carsonanumm) + tonumber(coniss)
Redis:set(SILV.."carsonanum"..Remsg.sender_id.user_id , carsonanoww)
sonanamed = "سوناتا"
Redis:set(SILV.."carsonaname"..Remsg.sender_id.user_id,sonanamed)
local carsonanum = Redis:get(SILV.."carsonanum"..msg.sender_id.user_id) or 0
if tonumber(carsonanum) == 0 then
Redis:del(SILV.."carsonaname"..msg.sender_id.user_id)
Redis:del(SILV.."carsonanum"..msg.sender_id.user_id)
...
local carcoronow = tonumber(carcoronum) - tonumber(coniss)
Redis:set(SILV.."carcoronum"..msg.sender_id.user_id , carcoronow)
local carcoronumm = Redis:get(SILV.."carcoronum"..Remsg.sender_id.user_id) or 0
local carcoronoww = tonumber(carcoronumm) + tonumber(coniss)
Redis:set(SILV.."carcoronum"..Remsg.sender_id.user_id , carcoronoww)
coronamed = "كورولا"
Redis:set(SILV.."carcoroname"..Remsg.sender_id.user_id,coronamed)
local carcoronum = Redis:get(SILV.."carcoronum"..msg.sender_id.user_id) or 0
if tonumber(carcoronum) == 0 then
Redis:del(SILV.."carcoroname"..msg.sender_id.user_id)
Redis:del(SILV.."carcoronum"..msg.sender_id.user_id)
...
if Redis:get(SILV.."zwag_request:"..msg.sender_id.user_id) then 
return send(msg.chat_id,msg.id, "⇜ في طلب باسمك انتظر قليلاً \n✧","md",true)
end
if tonumber(coniss) < 10000 then
return send(msg.chat_id,msg.id, "⇜ الحد الادنى المسموح به هو 10000 دولار \n✧","md",true)
end
ballancee = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
...
local UserInfo = bot.getUser(Remsg.sender_id.user_id)
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n⇜بوت مو للزواج 🤣","md",true)  
return false
end
if Redis:get(SILV.."roog1"..msg.sender_id.user_id) then
send(msg.chat_id,msg.id, "⇜ ابك تراك متزوج !!","md",true)
return false
end
if Redis:get(SILV.."rooga1"..msg.sender_id.user_id) then
send(msg.chat_id,msg.id, "⇜ ابك تراك متزوج !!","md",true)
return false
end
if Redis:get(SILV.."roog1"..Remsg.sender_id.user_id) then
send(msg.chat_id,msg.id, "⇜ ابعد بعيد لاتحوس وتدور حول المتزوجين","md",true)
return false
end
if Redis:get(SILV.."rooga1"..Remsg.sender_id.user_id) then
send(msg.chat_id,msg.id, "⇜ ابعد بعيد لاتحوس وتدور حول المتزوجين","md",true)
return false
end
if Redis:sismember(SILV.."booob",msg.sender_id.user_id) then
...
Redis:setex(SILV.."zwag_request:"..msg.sender_id.user_id,60,true)
Redis:setex(SILV.."zwag_request:"..Remsg.sender_id.user_id,60,true)
...
if Redis:sismember(SILV.."roogg1",msg.sender_id.user_id) or Redis:sismember(SILV.."roogga1",msg.sender_id.user_id) then
local zoog = Redis:get(SILV.."roog1"..msg.sender_id.user_id)
local zooga = Redis:get(SILV.."rooga1"..msg.sender_id.user_id)
local mahr = Redis:get(SILV.."rahr1"..msg.sender_id.user_id)
...
if Redis:sismember(SILV.."roogg1",Remsg.sender_id.user_id) or Redis:sismember(SILV.."roogga1",Remsg.sender_id.user_id) then
if Redis:sismember(SILV.."booob",msg.sender_id.user_id) then
ballancee = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
if tonumber(ballancee) < 100 then
return send(msg.chat_id,msg.id, "⇜ فلوسك ماتكفي \n✧","md",true)
...
local UserInfo = bot.getUser(Remsg.sender_id.user_id)
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n⇜بوت مو متزوجه ","md",true)  
return false
end
local zoog = Redis:get(SILV.."roog1"..Remsg.sender_id.user_id)
local zooga = Redis:get(SILV.."rooga1"..Remsg.sender_id.user_id)
local mahr = Redis:get(SILV.."rahr1"..Remsg.sender_id.user_id)
local bandd = bot.getUser(zoog)
if bandd.first_name then
neews = "["..bandd.first_name.."](tg://user?id="..bandd.id..")"
else
...
local convert_mony = string.format("%.0f",mahr)
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(otheka))
...
local zoog = Redis:get(SILV.."roog1"..msg.sender_id.user_id)
local zooga = tonumber(Redis:get(SILV.."rooga1"..msg.sender_id.user_id))
...
Redis:del(SILV.."rahr1"..msg.sender_id.user_id)
Redis:del(SILV.."rahrr1"..msg.sender_id.user_id)
Redis:srem(SILV.."roogg1", zooga)
Redis:srem(SILV.."roogga1", zooga)
Redis:del(SILV.."roog1"..zooga)
Redis:del(SILV.."rooga1"..zooga)
Redis:del(SILV.."rahr1"..zooga)
Redis:del(SILV.."rahrr1"..zooga)
...
local mahrr = Redis:get(SILV.."rahrr1"..msg.sender_id.user_id)
local bandd = bot.getUser(zoog)
if bandd.first_name then
neews = "["..bandd.first_name.."](tg://user?id="..bandd.id..")"
else
...
ballancee = Redis:get(SILV.."boob"..zoog) or 0
kalea = ballancee + mahrr
Redis:set(SILV.."boob"..zoog , kalea)
...
Redis:srem(SILV.."roogg1", zoog)
Redis:srem(SILV.."roogga1", zoog)
Redis:del(SILV.."roog1"..zoog)
Redis:del(SILV.."rooga1"..zoog)
Redis:del(SILV.."rahr1"..zoog)
Redis:del(SILV.."rahrr1"..zoog)
Redis:srem(SILV.."roogg1", msg.sender_id.user_id)
Redis:srem(SILV.."roogga1", msg.sender_id.user_id)
Redis:del(SILV.."roog1"..msg.sender_id.user_id)
Redis:del(SILV.."rooga1"..msg.sender_id.user_id)
...
return send(msg.chat_id,msg.id, "⇜ الحد الادنى المسموح هو 1000 دولار 💵\n✧","md",true)
end
if tonumber(ballancee) < tonumber(coniss) then
return send(msg.chat_id,msg.id, "⇜ فلوسك ماتكفي \n✧","md",true)
end
...
Redis:del(SILV..'List_rhan'..msg.chat_id)  
...
Redis:set(SILV.."raeahkam"..msg.chat_id,msg.sender_id.user_id)
Redis:sadd(SILV..'List_rhan'..msg.chat_id,msg.sender_id.user_id)
Redis:setex(SILV.."Start_rhan"..msg.chat_id,3600,true)
Redis:set(SILV.."allrhan"..msg.chat_id..12345 , coniss)
local ballancee = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
...
if text == 'نعم' and Redis:get(SILV.."Witting_Startrhan"..msg.chat_id) then
rarahkam = Redis:get(SILV.."raeahkam"..msg.chat_id)
if tonumber(rarahkam) == msg.sender_id.user_id then
local list = Redis:smembers(SILV..'List_rhan'..msg.chat_id) 
if #list == 1 then 
...
local ballancee = Redis:get(SILV.."boob"..UserName) or 0
rehane = tonumber(benrahan) / 100 * 25
rehan = tonumber(ballancee) + math.floor(rehane)
Redis:set(SILV.."boob"..UserName , rehan)
local rhan_users = Redis:smembers(SILV.."List_rhan"..msg.chat_id)
for k,v in pairs(rhan_users) do
Redis:del(SILV..'playercoins'..msg.chat_id..v)
end
Redis:del(SILV..'allrhan'..msg.chat_id..12345) 
Redis:del(SILV..'playerrhan'..msg.chat_id) 
Redis:del(SILV..'raeahkam'..msg.chat_id) 
Redis:del(SILV..'List_rhan'..msg.chat_id) 
Redis:del(SILV.."Witting_Startrhan"..msg.chat_id)
Redis:del(SILV.."Start_rhan"..msg.chat_id)
local ballancee = Redis:get(SILV.."boob"..UserName) or 0
local convert_mony = string.format("%.0f",rehane)
local convert_monyy = string.format("%.0f",ballancee)
return send(msg.chat_id,msg.id,'⌯ فاز '..ls..' بالرهان 🎊\n⇜ المبلغ : '..convert_mony..' دولار 💵\n⇜ خصمت 25% ضريبة \n⇜ رصيدك الان : '..convert_monyy..' دولار 💵\n✧',"md",true)
end
end
--------------------------------------------------------------------------------------------------------------
...
if Redis:sismember(SILV.."booob",msg.sender_id.user_id) then
if Redis:get(SILV.."namenade"..msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ لديك نادي مسبقاً ","md",true)
end
if Redis:sismember(SILV.."lkbnadesadd", Cnamed) then
return send(msg.chat_id,msg.id, "⇜ الاسم موجود مسبقاً\n⇜ اختر اسم اخر\n✧","md",true)
end
Redis:set(SILV.."lkbnade"..msg.sender_id.user_id, Cnamed)
...
Redis:del(SILV.."priceplayer".."4"..msg.sender_id.user_id)
Redis:del(SILV.."priceplayer".."5"..msg.sender_id.user_id)
Redis:srem(SILV.."lkbnadesadd", namfra)
Redis:srem(SILV.."ownernade",msg.sender_id.user_id)
Redis:del(SILV.."lkbnade"..msg.sender_id.user_id)
...
if Redis:ttl(SILV.."traningnade" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(SILV.."traningnade" .. msg.sender_id.user_id))
...
namenade = Redis:get(SILV.."namenade"..msg.sender_id.user_id)
energynade = Redis:get(SILV.."energynade"..msg.sender_id.user_id)
lkbnade = Redis:get(SILV.."lkbnade"..msg.sender_id.user_id)
namenade = Redis:get(SILV.."namenade"..msg.sender_id.user_id)
energyplayer1 = Redis:get(SILV.."energyplayer".."1"..msg.sender_id.user_id)
energyplayer2 = Redis:get(SILV.."energyplayer".."2"..msg.sender_id.user_id)
energyplayer3 = Redis:get(SILV.."energyplayer".."3"..msg.sender_id.user_id)
energyplayer4 = Redis:get(SILV.."energyplayer".."4"..msg.sender_id.user_id)
energyplayer5 = Redis:get(SILV.."energyplayer".."5"..msg.sender_id.user_id)
if tonumber(energynade) < 151 then
Redis:incrby(SILV.."energynade"..msg.sender_id.user_id,1)
end
if energyplayer1 then
if tonumber(energyplayer1) < 151 then
Redis:incrby(SILV.."energyplayer".."1"..msg.sender_id.user_id,1)
end
end
if energyplayer2 then
if tonumber(energyplayer2) < 151 then
Redis:incrby(SILV.."energyplayer".."2"..msg.sender_id.user_id,1)
end
end
if energyplayer3 then
if tonumber(energyplayer3) < 151 then
Redis:incrby(SILV.."energyplayer".."3"..msg.sender_id.user_id,1)
end
end
if energyplayer4 then
if tonumber(energyplayer4) < 151 then
Redis:incrby(SILV.."energyplayer".."4"..msg.sender_id.user_id,1)
end
end
if energyplayer5 then
if tonumber(energyplayer5) < 151 then
Redis:incrby(SILV.."energyplayer".."5"..msg.sender_id.user_id,1)
end
end
energynade = Redis:get(SILV.."energynade"..msg.sender_id.user_id)
Redis:setex(SILV.."traningnade" .. msg.sender_id.user_id,1800, true)
...
Redis:setex(SILV.."changlkbnade" .. msg.chat_id .. ":" .. msg.sender_id.user_id,60, true)
...
if Redis:get(SILV.."changlkbnade" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
Redis:del(SILV.."changlkbnade" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
if text == "الغاء" or text == "الغاء الامر" then
return send(msg.chat_id,msg.id, "⇜ تم الغاء امر تغيير لقب النادي","md",true)
end
if Redis:sismember(SILV.."lkbnadesadd", text) then
return send(msg.chat_id,msg.id, "⇜ الاسم موجود مسبقاً\n⇜ اختر اسم اخر\n✧","md",true)
end
namfra = Redis:get(SILV.."lkbnade"..msg.sender_id.user_id)
Redis:srem(SILV.."lkbnadesadd", namfra)
Redis:del(SILV.."lkbnade"..msg.sender_id.user_id)
Redis:set(SILV.."lkbnade"..msg.sender_id.user_id, text)
Redis:sadd(SILV.."lkbnadesadd", text)
ballance = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
cccallcc = tonumber(ballance) - 25000
Redis:set(SILV.."boob"..msg.sender_id.user_id,cccallcc)
ballance = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
local convert_mony = string.format("%.0f",ballance)
send(msg.chat_id,msg.id, "⇜ تم تغيير لقب ناديك\n\n⇜ اللقب الجديد : "..text.."\n⇜ سعر تغيير اللقب : 25000 دولار 💵\n⇜ رصيدك الان : "..convert_mony.." دولار 💵\n✧","md",true)
end
...
nameplayer1 = Redis:get(SILV.."nameplayer".."1"..msg.sender_id.user_id)
nameplayer2 = Redis:get(SILV.."nameplayer".."2"..msg.sender_id.user_id)
nameplayer3 = Redis:get(SILV.."nameplayer".."3"..msg.sender_id.user_id)
nameplayer4 = Redis:get(SILV.."nameplayer".."4"..msg.sender_id.user_id)
nameplayer5 = Redis:get(SILV.."nameplayer".."5"..msg.sender_id.user_id)
if nameplayer1 then
mrkzplayer1 = Redis:get(SILV.."mrkzplayer".."1"..msg.sender_id.user_id)
cityplayer1 = Redis:get(SILV.."cityplayer".."1"..msg.sender_id.user_id)
energyplayer1 = Redis:get(SILV.."energyplayer".."1"..msg.sender_id.user_id)
priceplayer1 = Redis:get(SILV.."priceplayer".."1"..msg.sender_id.user_id)
nameplayer1done = "⌯ اسم اللاعب : `"..nameplayer1.."`\n- مركزه : "..mrkzplayer1.."\n- طاقة اللاعب : "..energyplayer1.."\n- الجنسية : "..cityplayer1.."\n- السعر : "..priceplayer1.."\n\n"
else
nameplayer1done = ""
end
if nameplayer2 then
mrkzplayer2 = Redis:get(SILV.."mrkzplayer".."2"..msg.sender_id.user_id)
cityplayer2 = Redis:get(SILV.."cityplayer".."2"..msg.sender_id.user_id)
energyplayer2 = Redis:get(SILV.."energyplayer".."2"..msg.sender_id.user_id)
priceplayer2 = Redis:get(SILV.."priceplayer".."2"..msg.sender_id.user_id)
nameplayer2done = "⌯ اسم اللاعب : `"..nameplayer2.."`\n- مركزه : "..mrkzplayer2.."\n- طاقة اللاعب : "..energyplayer2.."\n- الجنسية : "..cityplayer2.."\n- السعر : "..priceplayer2.."\n\n"
else
nameplayer2done = ""
end
if nameplayer3 then
mrkzplayer3 = Redis:get(SILV.."mrkzplayer".."3"..msg.sender_id.user_id)
cityplayer3 = Redis:get(SILV.."cityplayer".."3"..msg.sender_id.user_id)
energyplayer3 = Redis:get(SILV.."energyplayer".."3"..msg.sender_id.user_id)
priceplayer3 = Redis:get(SILV.."priceplayer".."3"..msg.sender_id.user_id)
nameplayer3done = "⌯ اسم اللاعب : `"..nameplayer3.."`\n- مركزه : "..mrkzplayer3.."\n- طاقة اللاعب : "..energyplayer3.."\n- الجنسية : "..cityplayer3.."\n- السعر : "..priceplayer3.."\n\n"
else
nameplayer3done = ""
end
if nameplayer4 then
mrkzplayer4 = Redis:get(SILV.."mrkzplayer".."4"..msg.sender_id.user_id)
cityplayer4 = Redis:get(SILV.."cityplayer".."4"..msg.sender_id.user_id)
energyplayer4 = Redis:get(SILV.."energyplayer".."4"..msg.sender_id.user_id)
priceplayer4 = Redis:get(SILV.."priceplayer".."4"..msg.sender_id.user_id)
nameplayer4done = "⌯ اسم اللاعب : `"..nameplayer4.."`\n- مركزه : "..mrkzplayer4.."\n- طاقة اللاعب : "..energyplayer4.."\n- الجنسية : "..cityplayer4.."\n- السعر : "..priceplayer4.."\n\n"
else
nameplayer4done = ""
end
if nameplayer5 then
mrkzplayer5 = Redis:get(SILV.."mrkzplayer".."5"..msg.sender_id.user_id)
cityplayer5 = Redis:get(SILV.."cityplayer".."5"..msg.sender_id.user_id)
energyplayer5 = Redis:get(SILV.."energyplayer".."5"..msg.sender_id.user_id)
priceplayer5 = Redis:get(SILV.."priceplayer".."5"..msg.sender_id.user_id)
...
Redis:setex(SILV.."shoplyname" .. msg.chat_id .. ":" .. msg.sender_id.user_id,60, true)
...
if Redis:get(SILV.."shoplyname" .. msg.chat_id .. ":" .. msg.sender_id.user_id) then
Redis:del(SILV.."shoplyname" .. msg.chat_id .. ":" .. msg.sender_id.user_id) 
if text == "الغاء" or text == "الغاء الامر" then
...
Redis:set(SILV.."boob"..msg.sender_id.user_id,pricetotaly)
Redis:del(SILV.."nameplayer".."1"..msg.sender_id.user_id)
Redis:del(SILV.."energyplayer".."1"..msg.sender_id.user_id)
Redis:del(SILV.."mrkzplayer".."1"..msg.sender_id.user_id)
Redis:del(SILV.."cityplayer".."1"..msg.sender_id.user_id)
...
energynade = Redis:get(SILV.."energynade"..msg.sender_id.user_id)
lkbnade = Redis:get(SILV.."lkbnade"..msg.sender_id.user_id)
nokatnade = Redis:get(SILV.."nokatnade"..msg.sender_id.user_id) or 0
nameplayer1 = Redis:get(SILV.."nameplayer".."1"..msg.sender_id.user_id)
nameplayer2 = Redis:get(SILV.."nameplayer".."2"..msg.sender_id.user_id)
nameplayer3 = Redis:get(SILV.."nameplayer".."3"..msg.sender_id.user_id)
nameplayer4 = Redis:get(SILV.."nameplayer".."4"..msg.sender_id.user_id)
...
local UserInfo = bot.getUser(Remsg.sender_id.user_id)
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n⇜بوت ماعندها نادي ","md",true)
return false
end
if not Redis:get(SILV.."namenade" .. Remsg.sender_id.user_id) then
...
namenade = Redis:get(SILV.."namenade"..Remsg.sender_id.user_id)
energynade = Redis:get(SILV.."energynade"..Remsg.sender_id.user_id)
lkbnade = Redis:get(SILV.."lkbnade"..Remsg.sender_id.user_id)
nokatnade = Redis:get(SILV.."nokatnade"..Remsg.sender_id.user_id) or 0
nameplayer1 = Redis:get(SILV.."nameplayer".."1"..Remsg.sender_id.user_id)
nameplayer2 = Redis:get(SILV.."nameplayer".."2"..Remsg.sender_id.user_id)
nameplayer3 = Redis:get(SILV.."nameplayer".."3"..Remsg.sender_id.user_id)
nameplayer4 = Redis:get(SILV.."nameplayer".."4"..Remsg.sender_id.user_id)
nameplayer5 = Redis:get(SILV.."nameplayer".."5"..Remsg.sender_id.user_id)
if nameplayer1 then
mrkzplayer1 = Redis:get(SILV.."mrkzplayer".."1"..Remsg.sender_id.user_id)
cityplayer1 = Redis:get(SILV.."cityplayer".."1"..Remsg.sender_id.user_id)
energyplayer1 = Redis:get(SILV.."energyplayer".."1"..Remsg.sender_id.user_id)
nameplayer1done = "⌯ اسم اللاعب : "..nameplayer1.."\n- مركزه : "..mrkzplayer1.."\n- طاقة اللاعب : "..energyplayer1.."\n- الجنسية : "..cityplayer1.."\n\n"
else
nameplayer1done = ""
end
if nameplayer2 then
mrkzplayer2 = Redis:get(SILV.."mrkzplayer".."2"..Remsg.sender_id.user_id)
cityplayer2 = Redis:get(SILV.."cityplayer".."2"..Remsg.sender_id.user_id)
energyplayer2 = Redis:get(SILV.."energyplayer".."2"..Remsg.sender_id.user_id)
nameplayer2done = "⌯ اسم اللاعب : "..nameplayer2.."\n- مركزه : "..mrkzplayer2.."\n- طاقة اللاعب : "..energyplayer2.."\n- الجنسية : "..cityplayer2.."\n\n"
else
nameplayer2done = ""
end
if nameplayer3 then
mrkzplayer3 = Redis:get(SILV.."mrkzplayer".."3"..Remsg.sender_id.user_id)
cityplayer3 = Redis:get(SILV.."cityplayer".."3"..Remsg.sender_id.user_id)
energyplayer3 = Redis:get(SILV.."energyplayer".."3"..Remsg.sender_id.user_id)
nameplayer3done = "⌯ اسم اللاعب : "..nameplayer3.."\n- مركزه : "..mrkzplayer3.."\n- طاقة اللاعب : "..energyplayer3.."\n- الجنسية : "..cityplayer3.."\n\n"
else
nameplayer3done = ""
end
if nameplayer4 then
mrkzplayer4 = Redis:get(SILV.."mrkzplayer".."4"..Remsg.sender_id.user_id)
cityplayer4 = Redis:get(SILV.."cityplayer".."4"..Remsg.sender_id.user_id)
energyplayer4 = Redis:get(SILV.."energyplayer".."4"..Remsg.sender_id.user_id)
nameplayer4done = "⌯ اسم اللاعب : "..nameplayer4.."\n- مركزه : "..mrkzplayer4.."\n- طاقة اللاعب : "..energyplayer4.."\n- الجنسية : "..cityplayer4.."\n\n"
else
nameplayer4done = ""
end
if nameplayer5 then
mrkzplayer5 = Redis:get(SILV.."mrkzplayer".."5"..Remsg.sender_id.user_id)
cityplayer5 = Redis:get(SILV.."cityplayer".."5"..Remsg.sender_id.user_id)
energyplayer5 = Redis:get(SILV.."energyplayer".."5"..Remsg.sender_id.user_id)
nameplayer5done = "⌯ اسم اللاعب : "..nameplayer5.."\n- مركزه : "..mrkzplayer5.."\n- طاقة اللاعب : "..energyplayer5.."\n- الجنسية : "..cityplayer5.."\n\n"
else
nameplayer5done = ""
end
...
if Redis:ttl(SILV.."matchode" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(SILV.."matchode" .. msg.sender_id.user_id))
...
namenade = Redis:get(SILV.."namenade"..msg.sender_id.user_id)
energynade = Redis:get(SILV.."energynade"..msg.sender_id.user_id)
energyplayer1 = Redis:get(SILV.."energyplayer".."1"..msg.sender_id.user_id) or 0
energyplayer2 = Redis:get(SILV.."energyplayer".."2"..msg.sender_id.user_id) or 0
energyplayer3 = Redis:get(SILV.."energyplayer".."3"..msg.sender_id.user_id) or 0
energyplayer4 = Redis:get(SILV.."energyplayer".."4"..msg.sender_id.user_id) or 0
energyplayer5 = Redis:get(SILV.."energyplayer".."5"..msg.sender_id.user_id) or 0
...
Redis:set(SILV.."boob"..msg.sender_id.user_id,cccallcc)
Redis:incrby(SILV.."energynade"..msg.sender_id.user_id,1)
Redis:incrby(SILV.."nokatnade"..msg.sender_id.user_id,1)
Redis:setex(SILV.."matchode" .. msg.sender_id.user_id,1200, true)
send(msg.chat_id,msg.id, "⌯ لقد فزت بالمبارة "..news.." ⚽️\n⇜ اسم النادي : "..namenade.."\n⇜ نادي الخصم : "..nadebot.."\n⇜ النتيجة : "..result.."\n⇜ تم زيادة نقطة لطاقة ناديك\n✧","md",true)
elseif energymynade < tonumber(energybot) then
Redis:decrby(SILV.."energynade"..msg.sender_id.user_id,1)
energynade = Redis:get(SILV.."energynade"..msg.sender_id.user_id)
if tonumber(energynade) < 0 then
Redis:set(SILV.."energynade"..msg.sender_id.user_id,0)
end
Redis:decrby(SILV.."nokatnade"..msg.sender_id.user_id,1)
nokatnade = Redis:get(SILV.."nokatnade"..msg.sender_id.user_id)
if tonumber(nokatnade) < 0 then
Redis:set(SILV.."nokatnade"..msg.sender_id.user_id,0)
end
Redis:setex(SILV.."matchode" .. msg.sender_id.user_id,1200, true)
...
if Redis:ttl(SILV.."matchplayer" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(SILV.."matchplayer" .. msg.sender_id.user_id))
...
namenadevs = Redis:get(SILV.."namenade"..Remsg.sender_id.user_id)
energynadevs = Redis:get(SILV.."energynade"..Remsg.sender_id.user_id)
energyplayer1vs = Redis:get(SILV.."energyplayer".."1"..Remsg.sender_id.user_id) or 0
energyplayer2vs = Redis:get(SILV.."energyplayer".."2"..Remsg.sender_id.user_id) or 0
energyplayer3vs = Redis:get(SILV.."energyplayer".."3"..Remsg.sender_id.user_id) or 0
energyplayer4vs = Redis:get(SILV.."energyplayer".."4"..Remsg.sender_id.user_id) or 0
energyplayer5vs = Redis:get(SILV.."energyplayer".."5"..Remsg.sender_id.user_id) or 0
...
Redis:decrby(SILV.."energynade"..Remsg.sender_id.user_id,1)
energynadevs = Redis:get(SILV.."energynade"..Remsg.sender_id.user_id)
if tonumber(energynadevs) < 0 then
Redis:set(SILV.."energynade"..Remsg.sender_id.user_id,0)
end
if energyplayer1vs then
Redis:decrby(SILV.."energyplayer".."1"..Remsg.sender_id.user_id,1)
end
energyplayer1vs = Redis:get(SILV.."energyplayer".."1"..Remsg.sender_id.user_id)
if tonumber(energyplayer1vs) < 0 then
Redis:set(SILV.."energyplayer".."1"..Remsg.sender_id.user_id,0)
end
if energyplayer2vs then
Redis:decrby(SILV.."energyplayer".."2"..Remsg.sender_id.user_id,1)
end
energyplayer2vs = Redis:get(SILV.."energyplayer".."2"..Remsg.sender_id.user_id)
if tonumber(energyplayer2vs) < 0 then
Redis:set(SILV.."energyplayer".."2"..Remsg.sender_id.user_id,0)
end
if energyplayer3vs then
Redis:decrby(SILV.."energyplayer".."3"..Remsg.sender_id.user_id,1)
end
energyplayer3vs = Redis:get(SILV.."energyplayer".."3"..Remsg.sender_id.user_id)
if tonumber(energyplayer3vs) < 0 then
Redis:set(SILV.."energyplayer".."3"..Remsg.sender_id.user_id,0)
end
if energyplayer4vs then
Redis:decrby(SILV.."energyplayer".."4"..Remsg.sender_id.user_id,1)
end
energyplayer4vs = Redis:get(SILV.."energyplayer".."4"..Remsg.sender_id.user_id)
if tonumber(energyplayer4vs) < 0 then
Redis:set(SILV.."energyplayer".."4"..Remsg.sender_id.user_id,0)
end
if energyplayer5vs then
Redis:decrby(SILV.."energyplayer".."5"..Remsg.sender_id.user_id,1)
end
energyplayer5vs = Redis:get(SILV.."energyplayer".."5"..Remsg.sender_id.user_id)
if tonumber(energyplayer5vs) < 0 then
Redis:set(SILV.."energyplayer".."5"..Remsg.sender_id.user_id,0)
end
Redis:decrby(SILV.."nokatnade"..Remsg.sender_id.user_id,1)
nokatnadevs = Redis:get(SILV.."nokatnade"..Remsg.sender_id.user_id)
if tonumber(nokatnadevs) < 0 then
Redis:set(SILV.."nokatnade"..Remsg.sender_id.user_id,0)
end
Redis:setex(SILV.."matchplayer" .. msg.sender_id.user_id,1200, true)
ballance = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
cccallcc = tonumber(ballance) + 1000000
Redis:set(SILV.."boob"..msg.sender_id.user_id,cccallcc)
send(msg.chat_id,msg.id, "⌯ لقد فزت بالمبارة "..news.." ⚽️\n⇜ اسم النادي : "..namenade.."\n⇜ نادي الخصم : "..namenadevs.."\n⇜ النتيجة : "..result.."\n⇜ الجائزة : 1000000 دولار 💵\n⇜ تم زيادة طاقة ناديك ولاعبينك وانقاصها من الخصم\n✧","md",true)
elseif energymynade < energymynadevs then
Redis:incrby(SILV.."energynade"..Remsg.sender_id.user_id,1)
Redis:incrby(SILV.."nokatnade"..Remsg.sender_id.user_id,1)
if energyplayer1vs then
Redis:incrby(SILV.."energyplayer".."1"..Remsg.sender_id.user_id,1)
end
if energyplayer2vs then
Redis:incrby(SILV.."energyplayer".."2"..Remsg.sender_id.user_id,1)
end
if energyplayer3vs then
Redis:incrby(SILV.."energyplayer".."3"..Remsg.sender_id.user_id,1)
end
if energyplayer4vs then
Redis:incrby(SILV.."energyplayer".."4"..Remsg.sender_id.user_id,1)
end
if energyplayer5vs then
Redis:incrby(SILV.."energyplayer".."5"..Remsg.sender_id.user_id,1)
end
Redis:decrby(SILV.."energynade"..msg.sender_id.user_id,1)
energynade = Redis:get(SILV.."energynade"..msg.sender_id.user_id)
if tonumber(energynade) < 0 then
...
if energyplayer1 then
Redis:decrby(SILV.."energyplayer".."1"..msg.sender_id.user_id,1)
end
energyplayer1 = Redis:get(SILV.."energyplayer".."1"..msg.sender_id.user_id)
if tonumber(energyplayer1) < 0 then
Redis:set(SILV.."energyplayer".."1"..msg.sender_id.user_id,0)
end
if energyplayer2 then
Redis:decrby(SILV.."energyplayer".."2"..msg.sender_id.user_id,1)
end
energyplayer2 = Redis:get(SILV.."energyplayer".."2"..msg.sender_id.user_id)
if tonumber(energyplayer2) < 0 then
Redis:set(SILV.."energyplayer".."2"..msg.sender_id.user_id,0)
end
if energyplayer3 then
Redis:decrby(SILV.."energyplayer".."3"..msg.sender_id.user_id,1)
end
energyplayer3 = Redis:get(SILV.."energyplayer".."3"..msg.sender_id.user_id)
if tonumber(energyplayer3) < 0 then
Redis:set(SILV.."energyplayer".."3"..msg.sender_id.user_id,0)
end
if energyplayer4 then
Redis:decrby(SILV.."energyplayer".."4"..msg.sender_id.user_id,1)
end
energyplayer4 = Redis:get(SILV.."energyplayer".."4"..msg.sender_id.user_id)
if tonumber(energyplayer4) < 0 then
Redis:set(SILV.."energyplayer".."4"..msg.sender_id.user_id,0)
end
if energyplayer5 then
Redis:decrby(SILV.."energyplayer".."5"..msg.sender_id.user_id,1)
end
energyplayer5 = Redis:get(SILV.."energyplayer".."5"..msg.sender_id.user_id)
if tonumber(energyplayer5) < 0 then
Redis:set(SILV.."energyplayer".."5"..msg.sender_id.user_id,0)
end
Redis:decrby(SILV.."nokatnade"..msg.sender_id.user_id,1)
nokatnade = Redis:get(SILV.."nokatnade"..msg.sender_id.user_id)
if tonumber(nokatnade) < 0 then
...
if Redis:sismember(SILV.."booob",msg.sender_id.user_id) then
if Redis:get(SILV.."mrkzplayer".."1"..msg.sender_id.user_id) and Redis:get(SILV.."mrkzplayer".."2"..msg.sender_id.user_id) and Redis:get(SILV.."mrkzplayer".."3"..msg.sender_id.user_id) and Redis:get(SILV.."mrkzplayer".."4"..msg.sender_id.user_id) and Redis:get(SILV.."mrkzplayer".."5"..msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ النادي الخاص بك مكتمل\n⇜ تستطيع بيع لاعب عن طريق الامر ( بيع لاعب )  ","md",true)
end
if Redis:ttl(SILV.."buyplayer" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(SILV.."buyplayer" .. msg.sender_id.user_id))
return send(msg.chat_id,msg.id,"⇜ تستطيع شراء لاعب بعد "..time.." ","md",true)
end
Redis:setex(SILV.."buyplayer" .. msg.sender_id.user_id,900, true)
...
msgplayer = "⇜ الاسم : سواريز\n⇜ مركزه : مهاجم ايمن\n⇜ طاقة اللاعب : 83\n⇜ الجنسية : اوكرانيا 🇺🇦\n⇜ سعر اللاعب : 39000 دولار 💵\n هل ترغب بشراء اللاعب ؟\n✧"
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
if Redis:sismember(SILV.."booob",msg.sender_id.user_id) then
ballanceed = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
namefram = Redis:get(SILV.."namefram"..msg.sender_id.user_id)
if Redis:get(SILV.."sizefram"..msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ لديك مزرعه مسبقاً ","md",true)
end
if Redis:sismember(SILV.."farmarname", Cnamed) then
return send(msg.chat_id,msg.id, "⇜ اسم المزرعه موجود مسبقاً\n⇜ اختر اسم اخر\n✧","md",true)
end
Redis:set(SILV.."namefram"..msg.sender_id.user_id, Cnamed)
...
if Redis:sismember(SILV.."booob",msg.sender_id.user_id) then
send(msg.chat_id,msg.id, "⌯ اهلا فيك بمزرعة :\n\n⇜ المزروعات واسعارها :\n- بطاطا : 75 دولار 💵\n- بندوره : 100 دولار 💵\n- خس : 125 دولار 💵\n- خيار : 150 دولار 💵\n- جزر : 175 دولار 💵\n- فليفله : 200 دولار 💵\n- فريز : 300 دولار 💵\n- ذره : 400 دولار 💵\n- ثوم : 500 دولار 💵\n- فطر : 800 دولار 💵\n- شجره تفاح : 1000 دولار 💵\n- شجره عنب : 1250 دولار 💵\n-شجره زيتون : 1500 دولار 💵\n- شجره موز : 2000 دولار 💵\n- شجره مانجا : 3000 دولار 💵\n\n⇜ مثال طريقة الزراعه : \n- زراعه بطاطا 10\n- زراعه شجر موز 15\n✧","md",true)
else
send(msg.chat_id,msg.id, "⇜ ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if Redis:sismember(SILV.."booob",msg.sender_id.user_id) then
if not Redis:get(SILV.."sizefram" .. msg.sender_id.user_id) then
...
local namefram = Redis:get(SILV.."namefram"..msg.sender_id.user_id)
local sizefram = Redis:get(SILV.."sizefram"..msg.sender_id.user_id)
local mzroatsize = Redis:get(SILV.."mzroatsize"..msg.sender_id.user_id) or 0
local mazofxbh = tonumber(sizefram) - tonumber(mzroatsize)
local btatahours = Redis:ttl(SILV.."btatatime" .. msg.sender_id.user_id) / 60
local btatatime = Redis:get(SILV.."btatatime" .. msg.sender_id.user_id)
local btataname = Redis:get(SILV.."btataname"..msg.sender_id.user_id)
local btatanum = Redis:get(SILV.."btatanum"..msg.sender_id.user_id) or 0
...
local lemonhours = Redis:ttl(SILV.."lemontime" .. msg.sender_id.user_id) / 60
local lemontime = Redis:get(SILV.."lemontime" .. msg.sender_id.user_id)
local lemonname = Redis:get(SILV.."lemonname"..msg.sender_id.user_id)
local lemonnum = Redis:get(SILV.."lemonnum"..msg.sender_id.user_id) or 0
...
local khesshours = Redis:ttl(SILV.."khesstime" .. msg.sender_id.user_id) / 60
local khesstime = Redis:get(SILV.."khesstime" .. msg.sender_id.user_id)
local khessname = Redis:get(SILV.."khessname"..msg.sender_id.user_id)
local khessnum = Redis:get(SILV.."khessnum"..msg.sender_id.user_id) or 0
...
local khearhours = Redis:ttl(SILV.."kheartime" .. msg.sender_id.user_id) / 60
local kheartime = Redis:get(SILV.."kheartime" .. msg.sender_id.user_id)
local khearname = Redis:get(SILV.."khearname"..msg.sender_id.user_id)
local khearnum = Redis:get(SILV.."khearnum"..msg.sender_id.user_id) or 0
...
local jzarhours = Redis:ttl(SILV.."jzartime" .. msg.sender_id.user_id) / 60
local jzartime = Redis:get(SILV.."jzartime" .. msg.sender_id.user_id)
local jzarname = Redis:get(SILV.."jzarname"..msg.sender_id.user_id)
local jzarnum = Redis:get(SILV.."jzarnum"..msg.sender_id.user_id) or 0
...
local fleflahours = Redis:ttl(SILV.."fleflatime" .. msg.sender_id.user_id) / 60
local fleflatime = Redis:get(SILV.."fleflatime" .. msg.sender_id.user_id)
local fleflaname = Redis:get(SILV.."fleflaname"..msg.sender_id.user_id)
local fleflanum = Redis:get(SILV.."fleflanum"..msg.sender_id.user_id) or 0
...
local freazhours = Redis:ttl(SILV.."freaztime" .. msg.sender_id.user_id) / 60
local freaztime = Redis:get(SILV.."freaztime" .. msg.sender_id.user_id)
local freazname = Redis:get(SILV.."freazname"..msg.sender_id.user_id)
local freaznum = Redis:get(SILV.."freaznum"..msg.sender_id.user_id) or 0
...
local dorahours = Redis:ttl(SILV.."doratime" .. msg.sender_id.user_id) / 60
local doratime = Redis:get(SILV.."doratime" .. msg.sender_id.user_id)
local doraname = Redis:get(SILV.."doraname"..msg.sender_id.user_id)
local doranum = Redis:get(SILV.."doranum"..msg.sender_id.user_id) or 0
...
local tomhours = Redis:ttl(SILV.."tomtime" .. msg.sender_id.user_id) / 60
local tomtime = Redis:get(SILV.."tomtime" .. msg.sender_id.user_id)
local tomname = Redis:get(SILV.."tomname"..msg.sender_id.user_id)
local tomnum = Redis:get(SILV.."tomnum"..msg.sender_id.user_id) or 0
...
local ftrhours = Redis:ttl(SILV.."ftrtime" .. msg.sender_id.user_id) / 60
local ftrtime = Redis:get(SILV.."ftrtime" .. msg.sender_id.user_id)
local ftrname = Redis:get(SILV.."ftrname"..msg.sender_id.user_id)
local ftrnum = Redis:get(SILV.."ftrnum"..msg.sender_id.user_id) or 0
...
local tfahhours = Redis:ttl(SILV.."tfahtime" .. msg.sender_id.user_id) / 60
local tfahtime = Redis:get(SILV.."tfahtime" .. msg.sender_id.user_id)
local tfahname = Redis:get(SILV.."tfahname"..msg.sender_id.user_id)
local tfahnum = Redis:get(SILV.."tfahnum"..msg.sender_id.user_id) or 0
...
local enabhours = Redis:ttl(SILV.."enabtime" .. msg.sender_id.user_id) / 60
local enabtime = Redis:get(SILV.."enabtime" .. msg.sender_id.user_id)
local enabname = Redis:get(SILV.."enabname"..msg.sender_id.user_id)
local enabnum = Redis:get(SILV.."enabnum"..msg.sender_id.user_id) or 0
...
local zetonhours = Redis:ttl(SILV.."zetontime" .. msg.sender_id.user_id) / 60
local zetontime = Redis:get(SILV.."zetontime" .. msg.sender_id.user_id)
local zetonname = Redis:get(SILV.."zetonname"..msg.sender_id.user_id)
local zetonnum = Redis:get(SILV.."zetonnum"..msg.sender_id.user_id) or 0
...
local mozzhours = Redis:ttl(SILV.."mozztime" .. msg.sender_id.user_id) / 60
local mozztime = Redis:get(SILV.."mozztime" .. msg.sender_id.user_id)
local mozzname = Redis:get(SILV.."mozzname"..msg.sender_id.user_id)
local mozznum = Redis:get(SILV.."mozznum"..msg.sender_id.user_id) or 0
...
local mangahours = Redis:ttl(SILV.."mangatime" .. msg.sender_id.user_id) / 60
local mangatime = Redis:get(SILV.."mangatime" .. msg.sender_id.user_id)
local manganame = Redis:get(SILV.."manganame"..msg.sender_id.user_id)
local manganum = Redis:get(SILV.."manganum"..msg.sender_id.user_id) or 0
...
if Redis:get(SILV.."btatatime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(SILV.."btatatime" .. msg.sender_id.user_id) / 60
...
if Redis:get(SILV.."btatanum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة بطاطا قبل 🥔\n⇜ قم بحصادها اولاً\n- طريقة الحصاد بالامر : `حصد بطاطا`","md",true)
end
kajwha = tonumber(coniss) * 0.7
sizefram = Redis:get(SILV.."sizefram"..msg.sender_id.user_id)
if tonumber(kajwha) > tonumber(sizefram) then
return send(msg.chat_id,msg.id, "⇜ مايمديك تشتري مساحة ارضك ماتكفي","md",true)
end
mzroatsize = Redis:get(SILV.."mzroatsize"..msg.sender_id.user_id) or 0
...
Redis:set(SILV.."btatanum"..msg.sender_id.user_id , coniss)
btataname = "بطاطا"
Redis:set(SILV.."btataname"..msg.sender_id.user_id , btataname)
mzroatsize = Redis:get(SILV.."mzroatsize"..msg.sender_id.user_id) or 0
btatasize = tonumber(coniss) * 0.7
btatasizee = btatasize + mzroatsize
Redis:set(SILV.."mzroatsize"..msg.sender_id.user_id , math.floor(btatasizee))
totalypalice = tonumber(ballance) - tonumber(btata)
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(SILV.."btatatime"..msg.sender_id.user_id,1220, true)
local convert_mony = string.format("%.0f",math.floor(btata))
toplvfarm = Redis:get(SILV.."toplvfarm"..msg.sender_id.user_id) or 0
toplvfarmm = tonumber(toplvfarm) + tonumber(coniss)
Redis:set(SILV.."toplvfarm"..msg.sender_id.user_id , toplvfarmm)
send(msg.chat_id,msg.id, "⇜ زرعة بطاطا 🥔\n⇜ العدد : "..math.floor(coniss).."\n⇜ السعر : "..convert_mony.." دولار 💵\n⇜ استنى 20 دقيقة ⏳️ ثم قم بحصادها\n- الامر ( `حصد بطاطا` )\n✧","md",true)
else
send(msg.chat_id,msg.id, "⇜ ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if Redis:get(SILV.."lemontime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(SILV.."lemontime" .. msg.sender_id.user_id) / 60
...
if Redis:get(SILV.."lemonnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة بندوره قبل 🍅\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد بندوره`","md",true)
end
...
Redis:set(SILV.."lemonnum"..msg.sender_id.user_id , coniss)
lemonname = "بندوره"
Redis:set(SILV.."lemonname"..msg.sender_id.user_id , lemonname)
mzroatsize = Redis:get(SILV.."mzroatsize"..msg.sender_id.user_id) or 0
lemonsize = tonumber(coniss) * 1
lemonsizee = lemonsize + mzroatsize
Redis:set(SILV.."mzroatsize"..msg.sender_id.user_id , math.floor(lemonsizee))
totalypalice = tonumber(ballance) - tonumber(lemon)
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(SILV.."lemontime"..msg.sender_id.user_id,1520, true)
...
if Redis:get(SILV.."khesstime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(SILV.."khesstime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة خس قبل 🥬\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصادها\n- طريقة الحصاد بالامر : `حصد خس`","md",true)
end
if Redis:get(SILV.."khessnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة خس قبل 🥬\n⇜ قم بحصادها اولاً\n- طريقة الحصاد بالامر : `حصد خس`","md",true)
end
...
Redis:set(SILV.."khessnum"..msg.sender_id.user_id , coniss)
khessname = "خس"
Redis:set(SILV.."khessname"..msg.sender_id.user_id , khessname)
mzroatsize = Redis:get(SILV.."mzroatsize"..msg.sender_id.user_id) or 0
khesssize = tonumber(coniss) * 1.2
khesssizee = khesssize + mzroatsize
Redis:set(SILV.."mzroatsize"..msg.sender_id.user_id , math.floor(khesssizee))
totalypalice = tonumber(ballance) - tonumber(khess)
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(SILV.."khesstime"..msg.sender_id.user_id,1800, true)
...
if Redis:get(SILV.."kheartime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(SILV.."kheartime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة خيار قبل 🥒\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد خيار`","md",true)
end
if Redis:get(SILV.."khearnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة خيار قبل 🥒\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد خيار`","md",true)
end
...
Redis:set(SILV.."khearnum"..msg.sender_id.user_id , coniss)
khearname = "خيار"
Redis:set(SILV.."khearname"..msg.sender_id.user_id , khearname)
mzroatsize = Redis:get(SILV.."mzroatsize"..msg.sender_id.user_id) or 0
khearsize = tonumber(coniss) * 1.5
khearsizee = khearsize + mzroatsize
Redis:set(SILV.."mzroatsize"..msg.sender_id.user_id , math.floor(khearsizee))
totalypalice = tonumber(ballance) - tonumber(khear)
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(SILV.."kheartime"..msg.sender_id.user_id,2120, true)
...
if Redis:get(SILV.."jzartime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(SILV.."jzartime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة جزر قبل 🥕\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد جزر`","md",true)
end
if Redis:get(SILV.."jzarnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة جزر قبل 🥕\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد جزر`","md",true)
end
...
Redis:set(SILV.."jzarnum"..msg.sender_id.user_id , coniss)
jzarname = "جزر"
Redis:set(SILV.."jzarname"..msg.sender_id.user_id , jzarname)
mzroatsize = Redis:get(SILV.."mzroatsize"..msg.sender_id.user_id) or 0
jzarsize = tonumber(coniss) * 1.7
jzarsizee = jzarsize + mzroatsize
Redis:set(SILV.."mzroatsize"..msg.sender_id.user_id , math.floor(jzarsizee))
totalypalice = tonumber(ballance) - tonumber(jzar)
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(SILV.."jzartime"..msg.sender_id.user_id,2420, true)
...
if Redis:get(SILV.."fleflatime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(SILV.."fleflatime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة فليفله قبل 🫑\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصادها\n- طريقة الحصاد بالامر : `حصد فليفله`","md",true)
end
if Redis:get(SILV.."fleflanum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة فليفله قبل 🫑\n⇜ قم بحصادها اولاً\n- طريقة الحصاد بالامر : `حصد فليفله`","md",true)
end
...
Redis:set(SILV.."fleflanum"..msg.sender_id.user_id , coniss)
fleflaname = "فليفله"
Redis:set(SILV.."fleflaname"..msg.sender_id.user_id , fleflaname)
mzroatsize = Redis:get(SILV.."mzroatsize"..msg.sender_id.user_id) or 0
fleflasize = tonumber(coniss) * 2
fleflasizee = fleflasize + mzroatsize
Redis:set(SILV.."mzroatsize"..msg.sender_id.user_id , math.floor(fleflasizee))
totalypalice = tonumber(ballance) - tonumber(flefla)
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(SILV.."fleflatime"..msg.sender_id.user_id,2720, true)
...
if Redis:get(SILV.."freaztime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(SILV.."freaztime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة فريز قبل 🍓\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد فريز`","md",true)
end
if Redis:get(SILV.."freaznum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة فريز قبل 🍓\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد فريز`","md",true)
end
...
Redis:set(SILV.."freaznum"..msg.sender_id.user_id , coniss)
freazname = "فريز"
Redis:set(SILV.."freazname"..msg.sender_id.user_id , freazname)
mzroatsize = Redis:get(SILV.."mzroatsize"..msg.sender_id.user_id) or 0
freazsize = tonumber(coniss) * 3
freazsizee = freazsize + mzroatsize
Redis:set(SILV.."mzroatsize"..msg.sender_id.user_id , math.floor(freazsizee))
totalypalice = tonumber(ballance) - tonumber(freaz)
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(SILV.."freaztime"..msg.sender_id.user_id,3020, true)
...
if Redis:get(SILV.."doratime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(SILV.."doratime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة ذره قبل 🌽\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد ذره`","md",true)
end
if Redis:get(SILV.."doranum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة ذره قبل 🌽\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد ذره`","md",true)
end
...
Redis:set(SILV.."doranum"..msg.sender_id.user_id , coniss)
doraname = "ذره"
Redis:set(SILV.."doraname"..msg.sender_id.user_id , doraname)
mzroatsize = Redis:get(SILV.."mzroatsize"..msg.sender_id.user_id) or 0
dorasize = tonumber(coniss) * 4
dorasizee = dorasize + mzroatsize
Redis:set(SILV.."mzroatsize"..msg.sender_id.user_id , math.floor(dorasizee))
totalypalice = tonumber(ballance) - tonumber(dora)
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(SILV.."doratime"..msg.sender_id.user_id,3320, true)
...
if Redis:get(SILV.."tomtime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(SILV.."tomtime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة ثوم قبل 🧄\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد ثوم`","md",true)
end
if Redis:get(SILV.."tomnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة ثوم قبل 🧄\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد ثوم`","md",true)
end
...
Redis:set(SILV.."tomnum"..msg.sender_id.user_id , coniss)
tomname = "ثوم"
Redis:set(SILV.."tomname"..msg.sender_id.user_id , tomname)
mzroatsize = Redis:get(SILV.."mzroatsize"..msg.sender_id.user_id) or 0
tomsize = tonumber(coniss) * 5
tomsizee = tomsize + mzroatsize
Redis:set(SILV.."mzroatsize"..msg.sender_id.user_id , math.floor(tomsizee))
totalypalice = tonumber(ballance) - tonumber(tom)
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(SILV.."tomtime"..msg.sender_id.user_id,3620, true)
...
if Redis:get(SILV.."ftrtime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(SILV.."ftrtime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة فطر قبل 🍄\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد فطر`","md",true)
end
if Redis:get(SILV.."ftrnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة فطر قبل 🍄\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد فطر`","md",true)
end
...
Redis:set(SILV.."ftrnum"..msg.sender_id.user_id , coniss)
ftrname = "فطر"
Redis:set(SILV.."ftrname"..msg.sender_id.user_id , ftrname)
mzroatsize = Redis:get(SILV.."mzroatsize"..msg.sender_id.user_id) or 0
ftrsize = tonumber(coniss) * 6
ftrsizee = ftrsize + mzroatsize
Redis:set(SILV.."mzroatsize"..msg.sender_id.user_id , math.floor(ftrsizee))
totalypalice = tonumber(ballance) - tonumber(ftr)
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(SILV.."ftrtime"..msg.sender_id.user_id,4220, true)
...
if Redis:get(SILV.."tfahtime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(SILV.."tfahtime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة شجر تفاح قبل 🍏\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد شجر تفاح`","md",true)
end
if Redis:get(SILV.."tfahnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة شجر تفاح قبل 🍏\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد شجر تفاح`","md",true)
end
...
Redis:set(SILV.."tfahnum"..msg.sender_id.user_id , coniss)
tfahname = "تفاح"
Redis:set(SILV.."tfahname"..msg.sender_id.user_id , tfahname)
mzroatsize = Redis:get(SILV.."mzroatsize"..msg.sender_id.user_id) or 0
tfahsize = tonumber(coniss) * 10
tfahsizee = tfahsize + mzroatsize
Redis:set(SILV.."mzroatsize"..msg.sender_id.user_id , math.floor(tfahsizee))
totalypalice = tonumber(ballance) - tonumber(tfah)
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(SILV.."tfahtime"..msg.sender_id.user_id,5420, true)
...
if Redis:get(SILV.."enabtime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(SILV.."enabtime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة شجر عنب قبل 🍇\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد شجر عنب`","md",true)
end
if Redis:get(SILV.."enabnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة شجر عنب قبل 🍇\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد شجر عنب`","md",true)
end
...
Redis:set(SILV.."enabnum"..msg.sender_id.user_id , coniss)
enabname = "عنب"
Redis:set(SILV.."enabname"..msg.sender_id.user_id , enabname)
mzroatsize = Redis:get(SILV.."mzroatsize"..msg.sender_id.user_id) or 0
enabsize = tonumber(coniss) * 12.5
enabsizee = enabsize + mzroatsize
Redis:set(SILV.."mzroatsize"..msg.sender_id.user_id , math.floor(enabsizee))
totalypalice = tonumber(ballance) - tonumber(enab)
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(SILV.."enabtime"..msg.sender_id.user_id,6020, true)
...
if Redis:get(SILV.."zetontime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(SILV.."zetontime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة شجر زيتون قبل 🫒\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد شجر زيتون`","md",true)
end
if Redis:get(SILV.."zetonnum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة شجر زيتون قبل 🫒\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد شجر زيتون`","md",true)
end
...
Redis:set(SILV.."zetonnum"..msg.sender_id.user_id , coniss)
zetonname = "زيتون"
Redis:set(SILV.."zetonname"..msg.sender_id.user_id , zetonname)
mzroatsize = Redis:get(SILV.."mzroatsize"..msg.sender_id.user_id) or 0
zetonsize = tonumber(coniss) * 15
zetonsizee = zetonsize + mzroatsize
Redis:set(SILV.."mzroatsize"..msg.sender_id.user_id , math.floor(zetonsizee))
totalypalice = tonumber(ballance) - tonumber(zeton)
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(SILV.."zetontime"..msg.sender_id.user_id,7220, true)
...
if Redis:get(SILV.."mozztime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(SILV.."mozztime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة شجر موز قبل 🍌\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد شجر موز`","md",true)
end
if Redis:get(SILV.."mozznum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة شجر موز قبل 🍌\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد شجر موز`","md",true)
end
...
Redis:set(SILV.."mozznum"..msg.sender_id.user_id , coniss)
mozzname = "موز"
Redis:set(SILV.."mozzname"..msg.sender_id.user_id , mozzname)
mzroatsize = Redis:get(SILV.."mzroatsize"..msg.sender_id.user_id) or 0
mozzsize = tonumber(coniss) * 20
mozzsizee = mozzsize + mzroatsize
Redis:set(SILV.."mzroatsize"..msg.sender_id.user_id , math.floor(mozzsizee))
totalypalice = tonumber(ballance) - tonumber(mozz)
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(SILV.."mozztime"..msg.sender_id.user_id,8420, true)
...
if Redis:get(SILV.."mangatime" .. msg.sender_id.user_id) then
local hours = Redis:ttl(SILV.."mangatime" .. msg.sender_id.user_id) / 60
return send(msg.chat_id,msg.id, "⇜ زرعة شجر مانجا قبل 🥭\n⇜ استنى "..math.floor(hours).." دقيقة ⏳️ ثم قم بحصاده\n- طريقة الحصاد بالامر : `حصد شجر مانجا`","md",true)
end
if Redis:get(SILV.."manganum" .. msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ زرعة شجر مانجا قبل 🥭\n⇜ قم بحصاده اولاً\n- طريقة الحصاد بالامر : `حصد شجر مانجا`","md",true)
end
...
Redis:set(SILV.."manganum"..msg.sender_id.user_id , coniss)
manganame = "مانجا"
Redis:set(SILV.."manganame"..msg.sender_id.user_id , manganame)
mzroatsize = Redis:get(SILV.."mzroatsize"..msg.sender_id.user_id) or 0
mangasize = tonumber(coniss) * 30
mangasizee = mangasize + mzroatsize
Redis:set(SILV.."mzroatsize"..msg.sender_id.user_id , math.floor(mangasizee))
totalypalice = tonumber(ballance) - tonumber(manga)
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(totalypalice))
Redis:setex(SILV.."mangatime"..msg.sender_id.user_id,10220, true)
...
if not Redis:get(SILV.."btatanum"..msg.sender_id.user_id) then
...
ballance = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
btatanum = Redis:get(SILV.."btatanum"..msg.sender_id.user_id)
btata = tonumber(btatanum) * 100
btataa = tonumber(ballance) + tonumber(btata)
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(btataa))
local convert_mony = string.format("%.0f",math.floor(btata))
...
if not Redis:get(SILV.."lemonnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
lemonnum = Redis:get(SILV.."lemonnum"..msg.sender_id.user_id)
lemon = tonumber(lemonnum) * 150
lemona = tonumber(ballance) + tonumber(lemon)
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(lemona))
local convert_mony = string.format("%.0f",math.floor(lemon))
...
if not Redis:get(SILV.."khessnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
khessnum = Redis:get(SILV.."khessnum"..msg.sender_id.user_id)
khess = tonumber(khessnum) * 200
khessa = tonumber(ballance) + tonumber(khess)
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(khessa))
local convert_mony = string.format("%.0f",math.floor(khess))
...
if not Redis:get(SILV.."khearnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
khearnum = Redis:get(SILV.."khearnum"..msg.sender_id.user_id)
khear = tonumber(khearnum) * 250
kheara = tonumber(ballance) + tonumber(khear)
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(kheara))
local convert_mony = string.format("%.0f",math.floor(khear))
...
if not Redis:get(SILV.."jzarnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
jzarnum = Redis:get(SILV.."jzarnum"..msg.sender_id.user_id)
jzar = tonumber(jzarnum) * 300
jzara = tonumber(ballance) + tonumber(jzar)
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(jzara))
local convert_mony = string.format("%.0f",math.floor(jzar))
...
if not Redis:get(SILV.."fleflanum"..msg.sender_id.user_id) then
...
ballance = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
fleflanum = Redis:get(SILV.."fleflanum"..msg.sender_id.user_id)
flefla = tonumber(fleflanum) * 350
fleflaa = tonumber(ballance) + tonumber(flefla)
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(fleflaa))
local convert_mony = string.format("%.0f",math.floor(flefla))
...
if not Redis:get(SILV.."freaznum"..msg.sender_id.user_id) then
...
ballance = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
freaznum = Redis:get(SILV.."freaznum"..msg.sender_id.user_id)
freaz = tonumber(freaznum) * 475
freaza = tonumber(ballance) + tonumber(freaz)
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(freaza))
local convert_mony = string.format("%.0f",math.floor(freaz))
...
if not Redis:get(SILV.."doranum"..msg.sender_id.user_id) then
...
ballance = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
doranum = Redis:get(SILV.."doranum"..msg.sender_id.user_id)
dora = tonumber(doranum) * 600
doraa = tonumber(ballance) + tonumber(dora)
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(doraa))
local convert_mony = string.format("%.0f",math.floor(dora))
...
if not Redis:get(SILV.."tomnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
tomnum = Redis:get(SILV.."tomnum"..msg.sender_id.user_id)
tom = tonumber(tomnum) * 725
toma = tonumber(ballance) + tonumber(tom)
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(toma))
local convert_mony = string.format("%.0f",math.floor(tom))
...
if not Redis:get(SILV.."ftrnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
ftrnum = Redis:get(SILV.."ftrnum"..msg.sender_id.user_id)
ftr = tonumber(ftrnum) * 800
ftra = tonumber(ballance) + tonumber(ftr)
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(ftra))
local convert_mony = string.format("%.0f",math.floor(ftr))
...
if not Redis:get(SILV.."tfahnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
tfahnum = Redis:get(SILV.."tfahnum"..msg.sender_id.user_id)
tfah = tonumber(tfahnum) * 1200
tfaha = tonumber(ballance) + tonumber(tfah)
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(tfaha))
local convert_mony = string.format("%.0f",math.floor(tfah))
...
if not Redis:get(SILV.."enabnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
enabnum = Redis:get(SILV.."enabnum"..msg.sender_id.user_id)
enab = tonumber(enabnum) * 1500
enaba = tonumber(ballance) + tonumber(enab)
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(enaba))
local convert_mony = string.format("%.0f",math.floor(enab))
...
if not Redis:get(SILV.."zetonnum"..msg.sender_id.user_id) then
...
ballance = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
zetonnum = Redis:get(SILV.."zetonnum"..msg.sender_id.user_id)
zeton = tonumber(zetonnum) * 1800
zetona = tonumber(ballance) + tonumber(zeton)
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(zetona))
local convert_mony = string.format("%.0f",math.floor(zeton))
...
if not Redis:get(SILV.."mozznum"..msg.sender_id.user_id) then
...
ballance = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
mozznum = Redis:get(SILV.."mozznum"..msg.sender_id.user_id)
mozz = tonumber(mozznum) * 2500
mozza = tonumber(ballance) + tonumber(mozz)
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(mozza))
local convert_mony = string.format("%.0f",math.floor(mozz))
...
if not Redis:get(SILV.."manganum"..msg.sender_id.user_id) then
...
ballance = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
manganum = Redis:get(SILV.."manganum"..msg.sender_id.user_id)
manga = tonumber(manganum) * 3500
mangaa = tonumber(ballance) + tonumber(manga)
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(mangaa))
local convert_mony = string.format("%.0f",math.floor(manga))
...
if text and text:match('انشاء شركه (.*)') or text and text:match('انشاء شركة (.*)') then -- شركات
local Cnamed = text:match('انشاء شركه (.*)') or text:match('انشاء شركة (.*)')
if Redis:sismember(SILV.."booob",msg.sender_id.user_id) then
ballanceed = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
if Redis:sismember(SILV.."in_company:" , msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ لديك شركة حاليا\n⇜ تستطيع استخدام الامر ( `استقاله` )\n✧","md",true)
end
if Redis:sismember(SILV.."company_owners:",msg.sender_id.user_id) then
...
if Redis:sismember(SILV.."companys:", Cnamed) then
return send(msg.chat_id,msg.id, "⇜ الاسم مأخوذ جرب اسم ثاني \n✧","md",true)
end
local shrkcoi = tonumber(ballancee) - 1000000
Redis:set(SILV.."boob"..msg.sender_id.user_id , shrkcoi)
Redis:sadd(SILV.."company_owners:", msg.sender_id.user_id)
local rand = math.random(1,99999999999999)
Redis:sadd(SILV.."companys:", Cnamed)
Redis:set(SILV.."companys_name:"..msg.sender_id.user_id, Cnamed)
Redis:set(SILV.."companys_owner:"..Cnamed, msg.sender_id.user_id)
Redis:set(SILV.."companys_id:"..rand, Cnamed)
Redis:set(SILV.."companys_id:"..Cnamed, rand)
Redis:sadd(SILV.."company:mem:"..Cnamed, msg.sender_id.user_id)
Redis:sadd(SILV.."in_company:", msg.sender_id.user_id)
local convert_mony = string.format("%.0f",ballancee)
send(msg.chat_id,msg.id,"⇜ تم انشاء شركتك\n⇜ اسم الشركة :"..Cnamed.."\n⇜ رصيد الشركة :"..convert_mony.." دولار 💵\n⇜ تستطيع اضافة اعضاء معك بالشركة\n⇜ ارسل الامر ( اضافه ) بالرد\n✧","md",true)
else
send(msg.chat_id,msg.id, "⇜ ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
...
if not Redis:sismember(SILV.."companys:", Cname) then return send(msg.chat_id,msg.id,"⇜ لا يوجد شركه بهذا الاسم","md",true) end
local owner_id = Redis:get(SILV.."companys_owner:"..Cname)
local Cowner_tag = "["..bot.getUser(owner_id).first_name.."](tg://user?id="..owner_id..")"
local Cid = Redis:get(SILV.."companys_id:"..Cname)
local Cmem = Redis:smembers(SILV.."company:mem:"..Cname)
local Cmony = 0
if #Cmem > 1 then 
...
mem_txt = mem_txt.."- "..mem_tag.."\nفلوسه :"..mem_mony.." دولار 💵\n\n"
end
Cmony = Cmony + mem_mony
end
local convert_mony = string.format("%.0f",Cmony)
send(msg.chat_id,msg.id,"⇜ تم ايجاد الشركه بنجاح\n\n⇜ صاحب الشركه :"..Cowner_tag.."\n⇜ ايدي الشركه :"..Cid.."\n⇜ فلوس الشركه :"..convert_mony.." دولار 💵\n"..mem_txt.."\n✧","md",true)
end
if text == "شركتي" then
if Redis:sismember(SILV.."booob",msg.sender_id.user_id) then
if not Redis:sismember(SILV.."in_company:", msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ انت غير موظف في اي شركة","md",true)  
end
local Cname = Redis:get(SILV.."companys_name:"..msg.sender_id.user_id) or Redis:get(SILV.."in_company:name:"..msg.sender_id.user_id)
local owner_id = Redis:get(SILV.."companys_owner:"..Cname)
local Cid = Redis:get(SILV.."companys_id:"..Cname)
local Cmem = Redis:smembers(SILV.."company:mem:"..Cname)
local Cmony = 0
...
for k,v in pairs(Cmem) do
local mem_mony = tonumber(Redis:get(SILV.."boob"..v))
if mem_mony then
if tonumber(v) ~= tonumber(owner_id) then
local mem_tag = "["..bot.getUser(v).first_name.."](tg://user?id="..v..")"
mem_txt = mem_txt.."- "..mem_tag.."\nفلوسه :"..mem_mony.." دولار 💵\n"
...
local Remsg = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
local UserInfo = bot.getUser(Remsg.sender_id.user_id)
if UserInfo and UserInfo.type and UserInfo.type.SILVbots == "userTypeBot" then
...
if not Redis:sismember(SILV.."company_owners:", msg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ ليس لديك شركه","md",true)  
end
if Redis:sismember(SILV.."booob",Remsg.sender_id.user_id) then
if Redis:sismember(SILV.."in_company:" , Remsg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ لديه شركة مسبقاً","md",true)
end
local Cname = Redis:get(SILV.."companys_name:"..msg.sender_id.user_id)
local Cmem = Redis:smembers(SILV.."company:mem:"..Cname)
if #Cmem == 5 then
return send(msg.chat_id,msg.id, "⇜ لقد وصلت شركتك لاقصى عدد من الموظفين\n⇜ تستطيع طرد الموظفين\n✧","md",true)
end
if Redis:get(SILV.."company_request:"..Remsg.sender_id.user_id) then
...
data = {
{
{text = 'موافق', data = Remsg.sender_id.user_id.."/company_yes/"..msg.sender_id.user_id},{text = 'لا', data = Remsg.sender_id.user_id.."/company_no/"..msg.sender_id.user_id},
},
}
}
Redis:setex(SILV.."company_request:"..Remsg.sender_id.user_id,60,true)
...
if (text == 'طرد الموظف' or text == 'رفض') and msg.reply_to_message_id ~= 0 then
ballanceed = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
if Redis:sismember(SILV.."booob",msg.sender_id.user_id) then
local Remsg = bot.getMessage(msg.chat_id, msg.reply_to_message_id)
local UserInfo = bot.getUser(Remsg.sender_id.user_id)
...
if Redis:sismember(SILV.."booob",Remsg.sender_id.user_id) then
local Cname = Redis:get(SILV.."companys_name:"..msg.sender_id.user_id)
if not Redis:sismember(SILV.."company:mem:"..Cname, Remsg.sender_id.user_id) then
return send(msg.chat_id,msg.id, "⇜ ليس لديك في الشركة مشان تطرده","md",true)  
end
Redis:srem(SILV.."company:mem:"..Cname, Remsg.sender_id.user_id)
Redis:srem(SILV.."in_company:", Remsg.sender_id.user_id)
Redis:del(SILV.."in_company:name:"..Remsg.sender_id.user_id, Cname)
...
local Cname = Redis:get(SILV.."in_company:name:"..msg.sender_id.user_id)
Redis:srem(SILV.."company:mem:"..Cname, msg.sender_id.user_id)
Redis:srem(SILV.."in_company:", msg.sender_id.user_id)
Redis:del(SILV.."in_company:name:"..msg.sender_id.user_id, Cname)
local owner_id = Redis:get(SILV.."companys_owner:"..Cname)
...
if Redis:ttl(SILV.."yiioooo" .. msg.sender_id.user_id) >=60 then
local hours = Redis:ttl(SILV.."yiioooo" .. msg.sender_id.user_id) / 60
...
Redis:set(SILV.."boob"..msg.sender_id.user_id , knez)
local ballancee = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
local convert_mony = string.format("%.0f",ballancee)
send(msg.chat_id,msg.id,""..neews.." لقد وجدت كنز\n⇜ الكنز : قطعة اثرية 🗳\n⇜ سعره : 40000 دولار 💵\n⇜ رصيدك الان : "..convert_mony.." دولار 💵\n✧","md",true)
Redis:setex(SILV.."yiioooo" .. msg.sender_id.user_id,1800, true)
elseif Descriptioont == "2" then
...
bot.sendAudio(msg.chat_id,msg.id,'./intk'..rand..'.mp3',tostring(inoi),"html",nil,tostring(inoi),"@Tepthon")
sleep(1)
...
local coniss = coin(UserName)
if msg.ControllerBot then
Redis:set(SILV.."bandid"..coniss,coniss)
...
local coniss = coin(UserName)
if msg.ControllerBot then
Redis:set(SILV.."morakba"..coniss,coniss)
local ban = bot.getUser(coniss)
if ban.first_name then
news = "["..ban.first_name.."](tg://user?id="..ban.id..")"
else
...
Redis:set(SILV.."cobonum"..numcobo,numcobo)
Redis:set(SILV.."cobon"..numcobo,coniss)
...
cobnum = Redis:get(SILV.."cobonum"..coniss)
if coniss == tonumber(cobnum) then
cobblc = Redis:get(SILV.."cobon"..coniss)
ballancee = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
cobonplus = ballancee + cobblc
Redis:set(SILV.."boob"..msg.sender_id.user_id , cobonplus)
local ballancee = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
local convert_mony = string.format("%.0f",ballancee)
Redis:del(SILV.."cobon"..coniss)
Redis:del(SILV.."cobonum"..coniss)
send(msg.chat_id,msg.id, "⌯ وصل كوبون \n\n⇜ المبلغ : "..cobblc.." دولار 💵\n⇜ رقم الكوبون : `"..coniss.."`\n⇜ رصيدك الان : `"..convert_mony.."` دولار 💵\n✧","md",true)
else
...
Redis:set(SILV.."boob"..Remsg.sender_id.user_id , bajiop)
ccccc = Redis:get(SILV.."boobb"..Remsg.sender_id.user_id)
uuuuu = Redis:get(SILV.."bbobb"..Remsg.sender_id.user_id)
ppppp = Redis:get(SILV.."rrfff"..Remsg.sender_id.user_id) or 0
ballanceed = Redis:get(SILV.."boob"..Remsg.sender_id.user_id) or 0
local convert_mony = string.format("%.0f",ballanceed)
send(msg.chat_id,msg.id, "⇜ الاسم ↢ "..news.."\n⇜ الحساب ↢ "..ccccc.."\n⇜ بنك ↢ (بوت )\n⇜ نوع ↢ ( "..uuuuu.." )\n⇜ الزرف ↢ ( "..ppppp.." دولار 💵 )\n⇜ صار رصيده ↢ ( "..convert_mony.." دولار 💵 )\n✧","md",true)
else
send(msg.chat_id,msg.id, "⇜ ماعنده حساب بنكي ","md",true)
end
end
...
ballanceed = Redis:get(SILV.."boob"..msg.sender_id.user_id) or 0
if tonumber(coniss) > 1000000001 then
return send(msg.chat_id,msg.id, "⇜ الحد الاعلى المسموح هو مليار دولار 💵\n✧","md",true)
end
if tonumber(coniss) < 999 then
return send(msg.chat_id,msg.id, "⇜ الحد الادنى المسموح هو 1000 دولار 💵\n✧","md",true)
end
...
Redis:set(SILV.."tdbelballance"..msg.sender_id.user_id , coniss)
local reply_markup = bot.replyMarkup{
type = 'inline',
data = {
{
...
local UserInfo = bot.getUser(Remsg.sender_id.user_id)
if UserInfo and UserInfo.type and UserInfo.type.luatele == "userTypeBot" then
send(msg.chat_id,msg.id,"\n⇜بوت ماعنده حساب بالبنك ","md",true)  
return false
end
if Redis:sismember(SILV.."booob",Remsg.sender_id.user_id) then
ballanceed = Redis:get(SILV.."boob"..Remsg.sender_id.user_id) or 0
...
if text == 'تبرع' then
if Redis:ttl(SILV.."tabrotime" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(SILV.."tabrotime" .. msg.sender_id.user_id))
...
return send(msg.chat_id,msg.id, "⇜ الحد الاعلى المسموح به هو 10000 دولار \n✧","md",true)
end
if tonumber(coniss) < 999 then
return send(msg.chat_id,msg.id, "⇜ الحد الادنى المسموح به هو 1000 دولار \n✧","md",true)
end
if Redis:ttl(SILV.."tabrotime" .. msg.sender_id.user_id) >=60 then
local time = ctime(Redis:ttl(SILV.."tabrotime" .. msg.sender_id.user_id))
return send(msg.chat_id,msg.id,"⇜ يمديك تتبرع بعد "..time.." ","md",true)
...
local user_name = bot.getUser(winner_id).first_name or Redis:get(SILV..winner_id.."first_name:") or "لا يوجد اسم"
tt =  "["..user_name.."]("..user_name..")"
...
Redis:set(SILV.."boob"..msg.sender_id.user_id , math.floor(byre))
taeswq = Redis:get(SILV.."tabbroat"..msg.sender_id.user_id) or 0
pokloo = tonumber(taeswq) + tonumber(coniss)
Redis:set(SILV.."tabbroat"..msg.sender_id.user_id , math.floor(pokloo))
ballanceeed = Redis:get(SILV.."boob"..winner_id) or 0
tekash = tonumber(ballanceeed) + tonumber(coniss)
Redis:set(SILV.."boob"..winner_id , tonumber(tekash))
ballanceeed = Redis:get(SILV.."boob"..winner_id) or 0
Redis:sadd(SILV.."taza",msg.sender_id.user_id)
Redis:setex(SILV.."tabrotime" .. msg.sender_id.user_id,600, true)
local convert_monyy = string.format("%.0f",tonumber(ballanceeed))
tttt = "⌯ وصل تبرع 📄\n\n⇜ من : "..news.."\n⇜ المستفيد : "..user_name.."\n⇜ المبلغ : "..convert_mony.." دولار 💵 \n⇜ فلوس المستفيد الان : "..convert_monyy.." دولار 💵\n✧"
...
if Redis:sismember(SILV.."booob",msg.sender_id.user_id) then
ballancee = Redis:get(SILV.."tabbroat"..msg.sender_id.user_id) or 0
if tonumber(ballancee) < 1 then
return send(msg.chat_id,msg.id, "⇜ ماعندك تبرعات \n✧","md",true)
end
local convert_mony = string.format("%.0f",ballancee)
send(msg.chat_id,msg.id, "⇜ تبرعاتك : `"..convert_mony.."` دولار 💵","md",true)
else
send(msg.chat_id,msg.id, "⇜ ماعندك حساب بنكي ارسل ↢ ( `انشاء حساب بنكي` )","md",true)
end
end
