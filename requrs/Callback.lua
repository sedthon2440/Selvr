...
local Text = '[🎙](t.me/'..(Redis:get(SILV..'Mero:Channel:Join') or 't.me/Tepthon')
keyboard = {}
...
local Text = '[🖋️](t.me/'..(Redis:get(SILV..'Mero:Channel:Join') or 't.me/Tepthon')
keyboard = {}
keyboard.inline_keyboard = {
{
...
◗حـــوࢪاء◖
⎯ ⎯ ⎯ ⎯ ⎯ ⎯ 
؏ٖـبيسہ‌َٖ ؏َـنعَآنِمہ🦅.
حٰموديہ‌َٖ ؏َـنعَآنِمہ🦅.
؏ٖـلشہ‌َٖ ؏َـنعَآنِمہ🦅.
حٰسو ؏َـنعَآنِمہ🦅.
 ححمہَ،د ؏َـنعَآنِمہ 🦅َ .
⎯ ⎯ ⎯ ⎯ ⎯ ⎯ 
﮼نفِࢪ سَـاد .
مــآࢪيد اެححـد،
مٛاެࢦيہ خَࢦڪٰٖك
...
edit(tonumber(UserId[3]),Msg_id,'⇜ تم مسح الرسالة من المجموعة', 'md', true)
end
end
...
link = "https://youtu.be/"..UserId[2]
title = UserId[1]
local se = http.request("http://selver-dev.zzz.com.ua/api/youtubesh.php?search="..URL.escape(link))
...
if yosfile then
bot.sendAudio(ChatId,Msg_id,'./'..title..'.mp3',"["..title.."](t.me/Tepthon) - "..nameuser.."","md",nil,title,musi,thumb)
bot.deleteMessages(ChatId,{[1]= Msg_id})
sleep(2)
os.remove(""..title..".mp3")
os.remove("image.jpg")
...
if yovfile then
bot.sendVideo(ChatId,Msg_id,'./'..title..'.mp4',"["..title.."](t.me/Tepthon)","md")
bot.deleteMessages(ChatId,{[1]= Msg_id})
sleep(2)
os.remove(""..title..".mp4")
Redis:del(SILV.."youtidche"..ChatId..IdUser)
...
local TextHelp = Reply_Status(kk_id,"⇜ تم كتمه في المجموعة لعدم تنفيذه العقاب").Reply
...
data = {
{{text = chsourceNa, url = 't.me/'..chsource},},}}
local TextHelp = Reply_Status(kk_id,"⇜ تم كتمه في المجموعة").Reply
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
else
https.request("https://api.telegram.org/bot"..Token..'/answerCallbackQuery?callback_query_id='..data.id..'&text='..URL.escape('هذا الامر للمشاركين في لعبة العقاب')..'&show_alert=true')
end
...
local TextHelp = Reply_Status(kk_id,"⇜ تم كتمه في المجموعة لعدم تنفيذه الاحكام").Reply
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
else
...
local TextHelp = Reply_Status(kk_id,"⇜ تم كتمه في المجموعة لعدم تنفذه الاحكام").Reply
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
else
...
local TextHelp = Reply_Status(kk_id,"⇜ تم الغاء كتمه في المجموعة").Reply
edit(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
else
https.request("https://api.telegram.org/bot"..Token..'/answerCallbackQuery?callback_query_id='..data.id..'&text='..URL.escape('هذا الامر للفائز بلعبة الاحكام')..'&show_alert=true')
end
...
⌯ توب الفلوس ↢ يطلع توب اكثر ناس معهم فلوس بكل المجموعةات
...
⌯ زواجات ↢ يطلع اغلى الزواجات بالمجموعة
