...
Bot_Name = (Redis:get(SILV.."Mero:Name:Bot") or "نونه")
...
local Bot_Name = (Redis:get(SILV.."Mero:Name:Bot") or "نونه")
...
KlamSpeeddd = {"ديل","زيتون","بن تن","ون بيس","نمله","توت","دكتور","باونتي","عسل","سابق ولاحق","دماغ","خروف","ميكي ماوس","كرسي","كيا","عين","بي ام دبليو","بشت","لاما","ببجي","سيمبا","سبونج بوب","شاي","طبله","كابتن ماجد","اليابان","بزر","ديك رومي","لاكوست","نوكيا","بطه","غوريلا","باب","كراش","لوتس","فرشه","اسعاف","تركيا","تشيلسي","طرزان","ال جي","نوتيلا","طفايه","عدنان ولينا","فتيات القوه","دمعه","قراند","قطط","سله","فلاش","يد","كبد","الصين","مكسرات","فيمتو","باباي","كانونه","مسجد","برايه","بطوط","باندا","كيندر","طياره","سنافر","الصين","سالي","بطريق","قرد","شاورما","ثريه","ميداليه","ماعز","سرير","هدى","بطاريه","احلام","نيسان","لابتوب","نسر","مسدس","مسواك","بير","قوقل","ملعب","دبابه","مغسله","سلم","دبور","كودو","بيانو","كهف","مشط","نقار الخشب","تفاح","طاوله","عنكبوت"};
name = KlamSpeeddd[math.random(#KlamSpeeddd)]
...
local gpt = text:match("^بوت (.*)$")  
local se = http.request("https://gptzaid.zaidbot.repl.co/1/text="..URL.escape(gpt))
...
Abs = math.random(2,140);
local Text = '[🎙](t.me/'..(Redis:get(SILV..'Mero:Channel:Join') or 'S0BMI')
...
local t = '[🖋️](t.me/'..(Redis:get(SILV..'Mero:Channel:Join') or 'S0BMI')
...
if text == "قيفات بنات" or text == "قيف بنات" or text == "متحركات بنات" then
if Redis:get(SILV.."trfeh"..msg.chat_id) then
return send(msg.chat_id,msg.id,"⇜ التسلية معطلة من قبل المشرفين","md",true)
end
keyboard = {} 
...
if text == "قيفات رومانسيه" or text == "قيفات رومانسية" or text == "متحركات رومانسية" then
if Redis:get(SILV.."trfeh"..msg.chat_id) then
return send(msg.chat_id,msg.id,"⇜ التسلية معطلة من قبل المشرفين","md",true)
end
keyboard = {} 
...
local t = "*🎆┊ تم اختيار صورة تطقيم لك*"
Rrr = math.random(2,115)
local m = "https://t.me/jsjjsphf/"..Rrr..""
local rep = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id="..msg_chat_id.."&caption="..URL.escape(t).."&photo="..m.."&reply_to_message_id="..rep.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
